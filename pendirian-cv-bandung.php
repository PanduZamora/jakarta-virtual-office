...
<head>
    ...
    <title>
        Pendirian CV Bandung Murah + Virtual Office - vOffice™
    </title>

    <meta name="description" content="Pendirian CV Bandung Murah vOffice ✔️ Gratis Konsultasi ✔️
    ...
    <div class="main-container">
            ...
            <ul class="slides">
                <li class="image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/pt-perorangan/bg/company-registration-6.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row text-left">
                            <div class="col-md-12 pt-xs-32 mt-5">
                                <h2 class="bold mb0"> Jasa Pendirian CV Bandung + Virtual Office<br>
                                </h2>
        ...
        <section id="selengkapnya">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img src="images/pt-perorangan/bg/company-registration-6.jpg" alt="" class="img-fluid img-pt-lite">
                    </div>
                    <div class="col-md-6">
