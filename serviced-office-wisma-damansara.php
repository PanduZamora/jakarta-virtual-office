...
<head>
    <meta charset="utf-8">
    <title>Office Space in Kuala Lumpur | Serviced Office Wisma UOA Damansara</title>

    <meta name="description" content="Office Space in Kuala Lumpur | Private Office, Serviced Office Wisma UOA Damansara" />
            ...
            <ul class="slides">
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_my/wisma_uoa/voffice-uoa-1.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-6 col-sm-8">
                                <h1 class="mb40 mb-xs-16 large mt100 mt-xs-0">Wisma UOA Damansara II</h1>
                                <h6 class="uppercase mb0">Level 9, Unit 3</h6>
                                <h6 class="uppercase mb0">Damansara Heights, 50490 Kuala Lumpur</h6>
                ...
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_my/wisma_uoa/voffice-uoa-2.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-6 col-sm-8">
                ...
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_my/wisma_uoa/voffice-uoa-3.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-6 col-sm-8">
                ...
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_my/wisma_uoa/voffice-uoa-4.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-6 col-sm-8">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        ...
                        <hr class="title-breaker left">
                        <p>
                            At vOffice - Plaza Mont Kiara center, we take pride in serving our clients from 9.00am to 7.30pm Monday to Friday and from 10am to 3pm on Saturday. Please feel free to contact us to find out how we can assist your business growth.
                        </p>
                        <hr>
                        ...
                        <table class="table table-blank">
                            <thead>
                                <tr>
                                    <th colspan="2">Establishments close to Plaza Mont Kiara</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>1 Mont Kiara</li>
                                            <li>DHL Express</li>
                                            <li>Mont'Kiara Dental Specialist Clinic</li>
                                            <li>Pos Malaysia</li>
                                            <a href="https://goo.gl/maps/osoB9xAr9R32" target="_blank">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="iframe-container mb24">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3983.783068679142!2d101.66383131401948!3d3.151835354016879!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc4854b336f29d%3A0xa3c176c5eda1b538!2sWisma+UOA+Damansara!5e0!3m2!1sid!2sid!4v1513829246913" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>

                    </div>
                    <div class="col-md-6">
                        <h4 class="bold">Contact Us</h4>
                        <p class="mb0">Wisma UOA Damansara II</p>
                        <p class="uppercase mb0">Level 9, Unit 3</p>
                        <p class="uppercase mb0">Damansara Heights, Taguig 50490 Kuala Lumpur</p>
