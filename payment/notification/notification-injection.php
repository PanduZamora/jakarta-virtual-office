...
$transaction = "capture";
$type = "credit_card";
$order_id = "VO-76100352";
$fraud = "accept";
$name =  "Evin Wijaya";
$email = "evin_w@ymail.com";
$whatsapp = "087897215960";
$location = "Menara Kuningan";
$plan = "Virtual Office Silver";
$terms = "12 Months";
$amount = 7150000;
...
//   $message = "<p>Berikut adalah data klien yang telah melakukan pembayaran melalui Buy-Now.</p>";
  $message = "<p>Testing New Mail Server, bagi yang menerima email ini mohon reply dengan isi 'sukses diterima' untuk keperluan testing</p>";
...
// <tr><td style='font-weight: bold;'>transaction id </td><td>: " . $order_id . "</td></tr>
...
// <tr><td style='font-weight: bold;'>Payment status </td><td>: " . $transaction . "</td></tr>
  ...
  $mail->AddReplyTo("hadiyusuf.voffice@gmail.com", "Hadi Web Dev");

  $mail->addAddress("hadiyusuf.voffice@gmail.com", "Hadi Yusuf Alghifari");
  $mail->addBCC("buynow@voffice.co.id", "AA vOffice");
