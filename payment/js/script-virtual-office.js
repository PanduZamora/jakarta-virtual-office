...
var geojson = {
  ...
  },
  {
    ...
    properties: {
      title: 'Spazio',
      description: 'Level 5, Jl. Mayjen Yono Suwoyo No.Kav 3, Dukuh Pakis, Surabaya',
...
function changeCity(){
  ...
  if (city == 'jakarta' || city == 'surabaya' || city == 'tangerang' || city == 'bali' || city == 'bekasi' || city == 'cibubur' || city == 'medan') {
  ...
  map.flyTo({center: [cityCoordinates1, cityCoordinates2], zoom: 11});
}
function subcity(){
  ...
  map.flyTo({center: [subCityCoordinates1, subCityCoordinates2], zoom: 13.5});
}
