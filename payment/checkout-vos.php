...
\Midtrans\Config::$serverKey = 'Mid-server-qq_oY9fty7bTPkrTAkbFQinE';
...
\Midtrans\Config::$overrideNotifUrl = 'https://voffice.co.id/jakarta-virtual-office/payment/notification/notification-vos.php';
...
<head>
    ...
    <!-- <script id="client-key" type="text/javascript" src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-Aurqtkz0yKL6OY3w"></script> -->
    <script id="client-key" type="text/javascript" src="https://app.midtrans.com/snap/snap.js" data-client-key="Mid-client-ibPAyKk7NoFvXXNr"></script>
