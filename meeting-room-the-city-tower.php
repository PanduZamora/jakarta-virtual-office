...
<head>
    <meta charset="utf-8">
    <title>Sewa Meeting Room Jakarta Pusat, The City Tower, MH Thamrin, vOffice Indonesia</title>

    <meta name="description" content="Sewa Ruang Meeting, Ruang Rapat,  Meeting Room Jakarta Pusat, The City Tower, MH Thamrin, vOffice Indonesia"/>

    <meta name="keywords" content="ruang rapat, ruang meeting, meeting room, MH Thamrin, the city tower, tct, virtual office, Menteng, Jakarta Pusat, virtual office jakarta, indonesia,
          ...
          <ul class="slides">
            <li class="overlay image-bg pt-xs-120">
                ...
                <div class="container v-align-transform">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="mb40 mb-xs-16 large mt64 mt-xs-0">The City Tower</h1>
                            <h6 class="uppercase mb0">Level 12 Unit 1-N, JL.M H Thamrin No.81</h6>
                            <h6 class="uppercase mb40">Jakarta Pusat 10310</h6>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="bold title">The City Tower</h4>
                            ...
                            <div class="col-sm-6 col-sm-offset-1">
                                <div class="feature bordered">
                                    ...
                                    <p class="mb80 mb-xs-24">
                                      ...
                                      <a class="btn-white btn btn-lg btn-filled  mb24"  href="#" data-toggle="modal"
                                           data-target="#contactus">
                                    Contact Us NOW</a>
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <img class="mt80 mt-xs-0 mb24" alt="Pic" src="img/locations/city-tower/tct-meet.jpg">
                                <img class="col-md-pull-4 relative mb24" alt="Pic" src="img/locations/city-tower/tct-lounge2.jpg">
                            </div>
                        </div>
