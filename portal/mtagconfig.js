...
//Remove cut long variables names and values. Trims suffix of the variable name above the 25th character onwards
    ...
    if (value.length>50 && name != 'leadSource' && name != 'referringUrl' && name != 'campaignUrl' && name != 'vehicle') { // Trims suffix of the variable value above the 50th character onwards
...
try{
	if (typeof(lpUnit)=='undefined') { var lpUnit='SL-WWW'; }
	...
	lpMTagConfig.defaultInvite ='chat-Sales'+ lpUnit+ '-' +lpLanguage;
}catch(e){}
