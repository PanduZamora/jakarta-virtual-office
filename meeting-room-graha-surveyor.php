...
<head>
    <meta charset="utf-8">
    <title>Meeting Room di Gatot Subroto, Graha Surveyor, Jakarta Selatan</title>

    <meta name="description" content="Sewa meeting room, ruang rapat, ruang meeting di Gatot Subroto, Graha Surveyor, Jakarta Selatan, vOffice Indonesia, Jakarta Virtual Office, Jakarta Serviced
Office, Indonesia Office - Instant Office di Jakarta, Indonesia -
Shared Office and Virtual Office Service in Jakarta Indonesia" />

    <meta name="keywords" content="ruang meeting, ruang rapat, meeting room, Gatot Subroto, Graha Surveyor, Jakarta Selatan, virtual office jakarta, indonesia,
            ...
            <ul class="slides">
                <li class="overlay image-bg pt-xs-120">
                    ...
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="mb40 mb-xs-16 large mt64 mt-xs-0">The Graha Surveyor</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="bold title">Graha Surveyor</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <img class="mt80 mt-xs-0 mb24" alt="Pic" src="img/locations/gs/gs-meet.jpg">
                                        <img class="col-md-pull-4 relative mb24" alt="Pic" src="img/locations/gs/graha-lounge.jpg">
                                    </div>
                                </div>
