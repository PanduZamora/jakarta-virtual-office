...
<head>
    <meta charset="utf-8">
    <title>Office Space Gatot Subroto | Serviced Office Graha Surveyor</title>

    <meta name="description" content="Office Space Gatot Subroto, Private Office, Serviced Office Graha Surveyor" />
            ...
            <ul class="slides">
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="img/serviced-office/gs-so.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="mbmin-1 mb-xs-32 large mt12 mt-xs-0">Serviced Office</h1>
                                <h1 class="mbmin-1 mb-xs-16 large  mt-xs-0">The Graha Surveyor</h1>
                                <h6 class="uppercase mb0">Level 15 Suite 1503, Jl Jend Gatot Subroto Kav 56</h6>
                                <h6 class="uppercase mb20">Jakarta Selatan 12950</h6>
                ...
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="virtual office sudirman" class="background-image" src="img/locations/gs/gs-meet.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                ...
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="virtual office SCBD" class="background-image" src="img/locations/gs/graha-lounge.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        ...
                        <p>
                            At vOffice - Graha Surveyor center, we take pride in serving our clients with outmost care and professionalism.
                        </p>
                        <hr>
                        ...
                        <table class="table table-blank">
                            <thead>
                                <tr>
                                    <th colspan="2">Establishments close to Graha Surveyor</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <td>
                                    <ul>
                                        ...
                                        <li>Embassy of The Republic Of Korea </li>
                                    </ul>
                                </td>
                                </tr>
                                </tr>
                                ...
                                <td>
                                    <ul>
                                        <li>Kuningan Toll Gate</li>
                                        <li>Medistra Hospital</li>
                                    </ul>
                                </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <img src="img/locations/gs/gs-floor.png">
                                    </td>
                    ...
                    <div class="col-sm-6 col-md-5 col-md-offset-1 mt24 mt-xs-64">
                        ...
                        <div>
                            ...
                            <div class="iframe-container mb24">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.1851345401847!2d106.83010121406811!3d-6.239313562832838!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3c25385af05%3A0x66ef1b08bec5bb5a!2sGraha+Surveyor!5e0!3m2!1sid!2sid!4v1503907027967" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                            </div>
                        </div>

                        <div class="feature bordered">
                            <h4 class="bold">Contact Us</h4>
                            <p class="mb0">The Graha Surveyor</p>
                            <p class="mb0">Level 15 Suite 1503, Jl Jend Gatot Subroto Kav 56</p>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="row masonry masonryFlyIn mb16">
                                ...
                                <div class="image-tile hover-tile text-center">
                                    ...
                                    <div class="hover-state">
                                        <a>
                                            ...
                                            <h6 class="uppercase">Graha Surveyor</h6>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4 masonry-item project" data-filter="People">
                                <div class="image-tile hover-tile text-center">
                                    <img alt="image" class="background-image" src="img/locations/gs/gs-meet.jpg">
                                    <div class="hover-state">
