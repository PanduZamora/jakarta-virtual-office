...
<head>
    <meta charset="utf-8">
    <title>Office Space Semanggi | Serviced Office Centennial Tower Jakarta Selatan - vOffice</title>

    <meta name="description" content="Office Space di Semanggi Kuningan, Private Office, Serviced Office Centennial Tower"/>
...
<div class="main-container">
    ...
    <section id="index-header" class="image-slider slider-all-controls controls-inside parallax pt0 pb0 height-70">
       <ul class="slides">
                ...
                <div class="container v-align-transform">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h1 class="mbmin-1 mb-xs-16 large mt-xs-0">Centennial Tower</h1>
            ...
            <li class="overlay image-bg pt-xs-120">
                <div class="background-image-holder">
                    <img alt="image" class="background-image" src="img/locations/centennial-tower/meeting-room.jpg">
                </div>
                <div class="container v-align-transform">
                    <div class="row">
                        <div class="col-md-12">
            ...
            <li class="overlay image-bg pt-xs-120">
                <div class="background-image-holder">
                    <img alt="image" class="background-image" src="img/locations/centennial-tower/lounge.jpg">
                </div>
                <div class="container v-align-transform">
                    <div class="row">
                        <div class="col-md-12">
        ...
        <div class="container">
            <div class="row">
                        <div class="col-md-6 col-sm-6">
                            ...
                            <p>
                                At vOffice - Centennial Tower center, we take pride in serving our clients with outmost care and professionalism.
                            </p>
                            <hr>
                            ...
                            <thead>
                            <tr>
                                <th colspan="2">Establishments close to Centennial Tower</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                            ...
                            <tr>
                                ...
                                <li>Apartment Taman Sari Semanggi</li>
                                <li>Pearl Garden Apartment</li>
                                <li>Regent Residence</li>
                                </ul>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                <img src="img/locations/centennial-tower/floorplan-ct.jpg">
                            </td>
                            ...
                            <div class="image-tile hover-tile text-center">
                                ...
                                <div class="hover-state">
                                    <a>
                                       ...
                                       <h6 class="uppercase">Centennial Tower</h6>
                                    </a>
                                </div>
                            </div>
