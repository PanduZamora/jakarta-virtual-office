...
var geojson = {
  ...
  features: [{
    ...
    },
    {
      ...
      geometry: {
        type: 'Point',
        coordinates: [827.6090441644192, -6.916837274043603]
      },
      properties: {
        title: 'Braga Bandung',
        description: 'Jalan Braga Nomor 109, Kecamatan Sumur, Kota Bandung, Jawa Barat 40111',
        image: 'img/bandung/bandung_braga 1.png',
        link: 'virtual-office-bandung.php'
      }
    }
  ]
};
...
function changeCity() {
  ...
  if (city == 'jakarta') {
    ...
    cityCoordinates1 = "827.6090441644192";
    cityCoordinates2 = "-6.916837274043603";
  }
  map.flyTo({
    center: [cityCoordinates1, cityCoordinates2],
    zoom: 11
