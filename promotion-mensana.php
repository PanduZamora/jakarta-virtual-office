...
<head>
    <meta charset="utf-8">
    <title>Promotion vOffice Mensana Tower</title>
                ...
                <div class="container v-align-transform">
                    <div class="row text-left">
                        <div class="col-md-10 mt88 mt-xs-36">
                            ...
                            <h2 class="mb8 number pt-xs-36">Get up to <b>50% off</b> For Serviced Office Mensana Tower</h2>
                            ...
                            <p class="small pb-xs-16 mb0">(Promo Valid until 31 December 2019)</p>
...
<!--                        productivity! </h4>-->
                ...
                <div class="col-sm-12">
                    <div class="col-sm-6 mb20">
                        <img src="images/promo 3 center mensana tower desember.jpg">
                    </div>
                    <div class="col-sm-6">
                        <div class="feature boxed3">
                            <h4 class="mb8 bold text-center color-black">Daftar Sekarang</h5>
                                ...
                                <form class="form-email"
                                    ...
                                    <input type="text" name="promo-mensana" hidden="hidden"
                                           value="promo-mensana"
                                           id="promo-mensana">
