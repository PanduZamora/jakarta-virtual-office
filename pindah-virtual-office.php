...
<head>
    <meta charset="utf-8">
    <title>Pindah Virtual Office</title>
        ...
        <div class="container">
            <div class="row place-self-center">
                <div class="col-md-5">
                    <div class="desc">
                        <h1 class="title em">
                            <span class="tt-n"> Lindungi Bisnis Anda</span>
                        </h1>
                        <p> Beralih ke Virtual Office Terbaik di Indonesia Sekarang</p>
                        <video controls class="mt-5 hide-pc" id="scbd" poster="assets/img/pindah-vo/thumb.png">
                            <source src="assets/img/pindah-vo/vid.mp4" type="video/mp4">
                            <source src="assets/img/pindah-vo/vid.ogg" type="video/ogg">
                ...
                <div class="col-md-7">
                    <video controls class="mt-5 hide-mobile" id="scbd" poster="assets/img/pindah-vo/thumb.png">
                        <source src="assets/img/pindah-vo/vid.mp4" type="video/mp4">
                        <source src="assets/img/pindah-vo/vid.ogg" type="video/ogg">
                        Your browser does not support the video tag.
                    </video>
