...
<head>
    <meta charset="utf-8">
    <title>Ruang Meeting | Meeting Room Surabaya, JAPFA Tower II 2</title>

    <meta name="description" content="Ruang Meeting, Ruang Rapat, Meeting Room Surabaya Panglima Sudirman, The JAPFA Tower II, vOffice Indonesia, Surabaya Virtual Office, Surabaya Serviced
...
Shared Office and Virtual Office Service in Surabaya Indonesia" />
    ...
    <meta name="keywords" content="meeting room, ruang meeting, ruang rapat, surabaya panglima Sudirman, virtual office surabaya, indonesia,
            ...
            <ul class="slides">
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="img/locations/bumi-mandiri-tower/bm1-meet2.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="mb40 mb-xs-16 large mt64 mt-xs-0">JAPFA Tower II</h1>
                                <h6 class="uppercase mb0">Level 12, Jl Panglima Sudirman Kav 66-68, Surabaya Pusat</h6>
                                <h6 class="uppercase mb40">Surabaya, Jawa Timur 60271</h6>
                ...
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="img/locations/bumi-mandiri-tower/bm2-lounge.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="bold title">JAPFA Tower II</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <img class="mt80 mt-xs-0 mb24" alt="Pic" src="img/locations/bumi-mandiri-tower/bm1-meet2.jpg">
                                        <img class="col-md-pull-4 relative mb24" alt="Pic" src="img/locations/bumi-mandiri-tower/bm2-lounge.jpg">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="iframe-container mb24">
                                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3957.7271829539286!2d112.74044731432024!3d-7.271853994751141!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7fbdf15555555%3A0xc90fd8c8b8dad28!2svOffice+Surabaya+-+Bumi+Mandiri+Tower+2!5e0!3m2!1sid!2sid!4v1503983689404" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                                    </div>

                                </div>
                                <div class="col-md-6">
                                    <h4 class="bold">Contact Us</h4>
                                    <p class="mb0">Bumi Putra Tower II</p>
                                    <p class="mb0">Level 12, Jl Panglima Sudirman Kav 66-68, Surabaya Pusat</p>
