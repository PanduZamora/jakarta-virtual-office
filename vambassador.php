...
<div class="main-container">
        ...
        <ul class="slides">
            <li class="overlay image-bg pt-xs-120">
                <div class="background-image-holder">
                    <img alt="image" class="background-image" src="img/crm/crm-8-header.JPG">
                </div>
                <div class="container v-align-transform">
                    <div class="row">
                         <div class="col-md-10 col-md-offset-1 text-center">
                             <h2 class="mb-xs-32 number bold" key="sectionone1"  style="margin-top:10%;" >Siapa yang dapat Menjadi vAmbassador?</h2>

                            <img class="logo logo-dark mtmin10" alt="vOffice Indonesia" src="img/crm/logo-light.png"
                                     style="width: 200px; margin-bottom: -3%; margin-top: -7%;">
                            <h6 class="bold-h6 mb0 mt-5-xs lang"  key="sectionone2">Smarter Business | Better Life</h6>
                            <h3 class="fw400 mb16 article" key="sectionone3">
                                Seluruh klien aktif vOffice dapat menjadi vAmbassador.
                            </h3>
                            <a class="btn btn-lg btn-filled mb-xs-8 lang" href="#seemore" key="sectionone4">Lihat Selengkapnya!</a>
    ...
    <section>
        <div class="container">
            <div class="row items-center-md">
                    ...
                    <div class="col-sm-6 mb24">
                        <img src="img/new/vambassador.jpg" class="border-radius-5">
                    </div>
                     <div class="col-md-6 mb24 content">
                        <h3 class="mb8 mb-xs-16 color-primary"><span class="bold">Apa itu vAmbassador?</span></h3>
    ...
    <section>
      <div class="container">
        <h3 class="text-center mb16 bold color-primary">Client (vAmbassador) Rewards Structure</h3>
    ...
    <section class="bg-secondary">
        <div class="conatiner">
             <div class="row text-center">
                        <div class="container">
                         <div class="col-sm-12">
                            <h3 class="bold mb16">Apa yang Dilakukan vAmbassador sebagai <br>  sebuah Komunitas?</h3>
                            <div class="hr mb24 center"></div>
                                <p class="p mt56 fw400 text-muted mb16 ">
                                   Kami mengadakan berbagai acara seperti
                                <p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 mb10">
                                      <div class="feature text-center boxedcrm">
                                        <img src="img/crm/charity.jpg" alt="Norway" style="width:100%">
                                        <div class="w3-container w3-center">
                                          <p class="color-black bold p10">Bakti Sosial</p>
                                        </div>
                                      </div>
                                </div>
                                 <div class="col-md-3 mb10">
                                      <div class="feature text-center boxedcrm">
                                        <img src="img/crm/event-6.JPG" alt="Norway" style="width:100%">
                                        <div class="w3-container w3-center">
                                          <p class="color-black bold p10">Networking</p>
                                        </div>
                                      </div>
                                </div>
                                 <div class="col-md-3 mb10">
                                      <div class="feature text-center boxedcrm">
                                        <img src="img/crm/event-4.JPG" alt="Norway" style="width:100%">
                                        <div class="w3-container w3-center">
                                          <p class="color-black bold p10">Seminar</p>
                                        </div>
                                      </div>
                                </div>
                                 <div class="col-md-3 mb10">
                                      <div class="feature text-center boxedcrm">
                                        <img src="img/crm/event-1.jpg" alt="Norway" style="width:100%">
                                        <div class="w3-container w3-center">
                                          <p class="color-black bold p10">Events</p>
                                        </div>
                                      </div>
                                </div>
                        </div>
    ...
    <section>
        <div class="container">
            <div class="row items-center-md">
                    ...
                    <div class="col-sm-6">
                        <img src="img/crm/benefit.jpg" class="border-radius-5">
                    </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 well bg-white">
                    ...
                    <h6 class="fw400 text-center mb10 text-muted"> Kami akan melakukan follow-up secara langsung untuk mendaftarkan rekomendasi Anda. </h6>
