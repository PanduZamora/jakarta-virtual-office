...
<head>
    <meta charset="utf-8">
    <title>Private Office Malaysia | Serviced Office Wisma Genting</title>

    <meta name="description" content="Private Office Malaysia, Office Space, Private Office, Serviced Office Wisma Genting" />
            ...
            <ul class="slides">
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_my/wisma_genting/voffice-gt-1.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-6 col-sm-8">
                                <h1 class="mb40 mb-xs-16 large mt64 mt-xs-0">Wisma Genting</h1>
                                <h6 class="uppercase mb0">Level 7-1, New Wing</h6>
                                <h6 class="uppercase mb40">Jln Sultan Ismail, 50250 Kuala Lumpur</h6>
                                <a class="btn btn-lg" href="#centerdetails">Start Exploring</a>
                            </div>
                        </div>
                    </div>
                </li>
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_my/wisma_genting/voffice-gt-2.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-6 col-sm-8">
                ...
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_my/wisma_genting/voffice-gt-3.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-6 col-sm-8">
                ...
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_my/wisma_genting/voffice-gt-4.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-6 col-sm-8">
            ...
            <div class="container">
                        ...
                        <div class="row masonry masonryFlyIn mb16">
                            <div class="col-sm-4 masonry-item project" data-filter="People">
                                <div class="image-tile hover-tile text-center">
                                    <img alt="image" class="background-image" src="images/voffice_my/wisma_genting/gt016.jpg">
                                    <div class="hover-state">
                                        <a>
                                            <h3 class="uppercase mb8">Private Office</h3>
                                            <h6 class="uppercase">Wisma UOA Damansara II</h6>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4 masonry-item project" data-filter="People">
                                <div class="image-tile hover-tile text-center">
                                    <img alt="image" class="background-image" src="images/voffice_my/wisma_genting/gt009.jpg">
                                    <div class="hover-state">
                                        <a>
                            ...
                            <div class="col-sm-4 masonry-item project" data-filter="People">
                                <div class="image-tile hover-tile text-center">
                                    <img alt="image" class="background-image" src="images/voffice_my/wisma_genting/gt001.jpg">
                                    <div class="hover-state">
                                        <a>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        ...
                        <hr class="title-breaker left">
                        <p>
                            At vOffice - Wisma Genting center, we take pride in serving our clients from 9.00am to 7.30pm Monday to Friday and from 10am to 3pm on Saturday. Please feel free to contact us to find out how we can assist your business growth.
                        </p>
                        <hr>
                        <table class="table table-striped table-bordered">
                            <tbody>
                                <tr>
                                    <th scope="row" width="40%">Contact Person</th>
                                    <td>Paz Quimado Lemi</td>
                                </tr>
                                <tr>
                        ...
                        <table class="table table-blank">
                            <thead>
                                <tr>
                                    <th colspan="2">Establishments close to Wisma Genting</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <th scope="row" width="40%">Bank</th>
                                    <td>
                                        <ul>
                                            <li>CIMB</li>
                                            <li>Maybank</li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="https://goo.gl/maps/HiPhzGBZBTA2" target="_blank">
                                            <i class="ti-map-alt icon-xs pull-left pull-left-sm"></i>
                                            <p class="inline-block p20 bold mb0">View location map</p>
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <div class="col-sm-6 col-md-5 col-md-offset-1 mt24 mt-xs-64">
                        ...
                        <div class="feature bordered">
                            <h5 class="bold-h6">Connect with us</h5>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="row text-center mb16">
                            ...
                            <div class="col-sm-2 col-xs-4">
                                ...
                                <p class="small bold">Pasport to Cre8 & vOffice Conference</p>
                            </div>
                            <div class="col-sm-2 col-xs-4">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="bold title">Our Locations </h4>
                        <hr class="title-breaker left">
                    </div>
                    <div class="col-md-6">
                        <div class="iframe-container mb24">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3983.787629724073!2d101.70882581401952!3d3.1506438540238775!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc362b3817ee05%3A0x9e764e48ed0f1d91!2sWisma+Genting%2C+28%2C+Jalan+Sultan+Ismail%2C+Kuala+Lumpur%2C+50450+Kuala+Lumpur%2C+Wilayah+Persekutuan+Kuala+Lumpur%2C+Malaysia!5e0!3m2!1sid!2sid!4v1513831957915" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>

                    </div>
                    <div class="col-md-6">
                        <h4 class="bold">Contact Us</h4>
                        <p class="mb0">Wisma Genting</p>
                        <p class="uppercase mb0">Level 7-1, New Wing</p>
                        <p class="uppercase mb0">Jalan Sultan Ismail, 50250 Kuala Lumpur</p>

                        <ul class="social-list">
                            <li class="small">
                                <a href="tel:+60327883555">
                                    <i class="fa fa-phone"></i> <span>+603 2788 3555</span>
                                </a>
                            </li>
                            <li class="small">
                                <a href="mailto:cs@voffice.com.my">
                                    <i class="ti-email"></i> <span>cs@voffice.com.my</span>
                                </a>

                            </li>
                            <li class="small">
                                <a href="http://voffice.com.my/" target="_blank">
                                    <i class="ti-world"></i> <span>www.voffice.com.my</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <hr class="fade-3-4 mb24">
                <div class="row">
                    <div class="col-md-4 text-center mb-xs-32">
                        <h4 class="bold title">Virtual Office</h4>
                        <img class="mb-xs-16" src="img/virtual-office-asmirandah.png" width="200px">
                        <h4>Mulai dari IDR<span class="number bold"> 600.000</span>/bln</h4>
                    ...
                    <div class="col-md-4 text-center mb-xs-32">
                        ...
                        <img class="mb-xs-16" src="img/so1.png" width="200px">
                        <h4>Mulai dari IDR<span class="number bold"> 2,5 Juta</span>/bln</h4>
                    ...
                    <div class="col-md-4 text-center">
                        ...
                        <img class="mb-xs-16" src="img/pt1.png" width="200px">
                        <h4>Mulai dari IDR<span class="number bold"> 4,3 Juta</span></h4>
