...
?><script src="js/jquery.min.js"></script><?
	...
	//live
		...
		$msg_in = "";
			...
			$client_msg_in = file_get_contents('client_mail_template.php?firstname=$firstname&lastname=$lastname');
...
<?
...

		{
			$offlink = OFFLINEURL;
				...
				$subject_in = "vOffice.com.my : Offline Payment Order : Ref : ". $ref_id;
