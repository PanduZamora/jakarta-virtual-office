...
<head>
    <meta charset="utf-8">
    <title>Office Space in Makati Phillippines | Serviced Office Mavenue Building</title>

    <meta name="description" content="Office Space in Makati Phillippines, Private Office, Serviced Office Mavenue Building" />
            ...
            <ul class="slides">
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_ph/mav/mav-gallery2.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-8 col-sm-8">
                                <h1 class="mb40 mb-xs-16 large mt64 mt-xs-0">Mavenue Building</h1>
                                <h6 class="uppercase mb0">Penthouse, 7884 Makati Avenue</h6>
                                <h6 class="uppercase mb40">Makati City 1209 Philippines</h6>
                ...
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_ph/mav/mav-gallery3.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-8 col-sm-8">
                ...
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_ph/mav/mav-gallery1.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-8 col-sm-8">
            ...
            <div class="container">
                                ...
                                <div class="image-tile hover-tile text-center">
                                    ...
                                    <div class="hover-state">
                                        <a>
                                            ...
                                            <h6 class="uppercase">Mavenue Building</h6>
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        ...
                        <hr class="title-breaker left">
                        <p>
                            At vOffice - Mavenue Building center, we take pride in serving our clients with outmost care and professionalism.
                        </p>
                        <hr>
                        ...
                        <table class="table table-blank">
                            <thead>
                                <tr>
                                    <th colspan="2">Establishments close to Mavenue Building</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="https://goo.gl/maps/yCsCHT8Zbur" target="_blank">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="iframe-container mb24">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1930.7957370357453!2d121.02886465803874!3d14.565338997456227!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397c9abaff8f4b5%3A0xc01c068cc7862852!2sMavenue!5e0!3m2!1sen!2sid!4v1513764585589" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>

                    </div>
                    <div class="col-md-6">
                        <h4 class="bold">Contact Us</h4>
                        <p class="mb0">Mavenue Building</p>
                        <p class="mb0">Penthouse, 7884 Makati Avenue</p>
                        <p class="mb0">Makati City 1209 Philippines</p>
