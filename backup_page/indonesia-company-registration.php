...
<head>
    ...
    <title>Buat PT & CV Perusahaan Murah di Jakarta, Jasa Bikin PT, CV | vOffice™</title>

    <meta name="description" content="Jasa Legalitas & Pembuatan Perusahaan Terpercaya di Indonesia ✓
    Buat PT ✓ CV ✓ PMA ✓ OSS ✓ NPWP ✓ Izin Usaha ✓ NIB ✓ PKP ✓ Penutupan PT/CV ✓ " />
...
<body>
    ...
    <div class="main-container">
                    ...
                    <div class="container v-align-transform">
                        <div class="row text-left">
                            <div class="col-md-12 pt-xs-32 mt-5">
                                <h2 class="bold mb0"> Jasa Buat PT, CV, <br>
                                    Pembuatan Perusahaan di Indonesia
                                </h2>
                                <p class="article mt-1">
                                    Cepat - Mudah - Professional
                                </p>
                                <a class="btn btn-lg btn-filled mb-xs-8" href="#selengkapnya">
                                    Lihat Selengkapnya!
                                </a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <h2 class="bold mb0"> Pendirian PT & CV </h2>
                    ...
                    <div class="col-sm-4">
                        <div class="custom-card box-shadow bt-5">
                            <div class="card-body-normal text-center">
                                ...
                                <h4 class="montserrat-600 color-grey mt30">IDR 5.5 JT</h4>
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="custom-card bg-white box-shadow bt-5">
                            <div class="card-body-normal text-center">
                                ...
                                <p class="color-black mb15">&nbsp;</p>
                                <img src="img/redesign/icon/pt_full_flat.png" width="100" class="mb10">
                                <h4 class="montserrat-600 color-grey mt30">IDR 7 JT</h4>
                            </div>
                            <ul class="text-left color-softgrey lists">
                                <li>
                                    <p>
                    ...
                    <div class="custom-card box-shadow bt-5">
                        ...
                        <p class="text-center" id="selengkapnya" onclick="showList(this);" data-target="#list-3">
                            Selengkapnya <i class="fa fa-angle-down"></i></p>
                        <p class="text-center lebih-sedikit" id="lebih-sedikit" data-target="#list-3"
                           style="display:none;" onclick="hideList(this);">Lebih sedikit <i class="fa fa-angle-up"></i>
                        </p>
                        <div class="text-center">
                            <a class="btn btn-filled font-size-11 mb20-xs mb20" href="#" data-toggle="modal"
                               data-target="#proposal_pt"> Minta Proposal </a>
                        </div>
                    </div>
                </div> -->
                    <!-- <div class="col-sm-3">
                    <div class="custom-card box-shadow bt-5">
                        ...
                        <p class="text-center" id="selengkapnya" onclick="showList(this);" data-target="#list-4">
                            Selengkapnya <i class="fa fa-angle-down"></i></p>
                        <p class="text-center lebih-sedikit" id="lebih-sedikit" data-target="#list-4"
                           style="display:none;" onclick="hideList(this);">Lebih sedikit <i class="fa fa-angle-up"></i>
                        </p>
                        <div class="text-center">
                            <a class="btn btn-filled font-size-11 mb20-xs mb20" href="#" data-toggle="modal"
      ...
      <div class="container">
        <div class="row mb-xs-0 items-center-md">
            <div class="col-sm-9">
                <h3 class="cardflexible-title bold">Gratis Pembuatan PT dengan Virtual Office 4.0</h3>
                <p class="mb24 article">
                    **Khusus 20 Pendaftar Pertama
                </p>
                <a href="virtual-office-40.php" class="btn btn-lg btn-filled" style="background:white!important;color:black!important;">
                  Lihat Selengkapnya
                </a>
            </div>
            <div class="col-sm-3 mb-xs-32">
              <img src="img/titi-kamal/pt-cv.jpeg">
            </div>
        </div>
      </div>
    </section> -->
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="custom-card bg-white box-shadow bt-5">
                        ...
                        <ul class="text-left color-softgrey lists">
                            ...
                            <div class="list-hidden" id="list-5">
                                <li>
                                    ...
                                    <i class="ti-check color-green fa-2x"></i></li>
                                <li>
                                    <p>
                                        NIB / TDP
                                    </p>
                        ...
                        <p class="text-center" id="selengkapnya" onclick="showList(this);" data-target="#list-5">
                            Selengkapnya <i class="fa fa-angle-down"></i></p>
                        <p class="text-center lebih-sedikit" id="lebih-sedikit" data-target="#list-5"
                           style="display:none;" onclick="hideList(this);">Lebih sedikit <i class="fa fa-angle-up"></i>
                        </p>
                        <div class="text-center">
                            <a class="btn btn-filled font-size-11 mb20-xs mb20" href="#" data-toggle="modal"
                               data-target="#proposal_cv"> Minta Proposal </a>
                        </div>
                    </div>
                </div> -->
        <!-- <div class="col-sm-3">
                    <div class="custom-card bg-white box-shadow bt-5">
                        <div class="card-body-normal text-center">
                            ...
                            <p class="color-black mb15">+ Virtual Office Lite</p>
                            <img src="img/redesign/icon/pt_full_vo_flat.png" width="100" class="mb10">
                            <h4 class="montserrat-600 color-grey mt30">IDR 8.9 JT</h4>
                        </div>
                        <ul class="text-left color-softgrey lists">
                            <li>
                                <p>
                        ...
                        <p class="text-center" id="selengkapnya" onclick="showList(this);" data-target="#list-6">
                            Selengkapnya <i class="fa fa-angle-down"></i></p>
                        <p class="text-center lebih-sedikit" id="lebih-sedikit" data-target="#list-6"
                           style="display:none;" onclick="hideList(this);">Lebih sedikit <i class="fa fa-angle-up"></i>
                        </p>
                        <div class="text-center">
                            <a class="btn btn-filled font-size-11 mb20-xs mb20" href="#" data-toggle="modal"
        ...
        <!-- <div class="col-sm-3">
                    <div class="custom-card bg-white box-shadow bt-5">
                        ...
                        <p class="text-center" id="selengkapnya" onclick="showList(this);" data-target="#list-7">
                            Selengkapnya <i class="fa fa-angle-down"></i></p>
                        <p class="text-center lebih-sedikit" id="lebih-sedikit" data-target="#list-7"
                           style="display:none;" onclick="hideList(this);">Lebih sedikit <i class="fa fa-angle-up"></i>
                        </p>
                        <div class="text-center">
                            <a class="btn btn-filled font-size-11 mb20-xs mb20" href="#" data-toggle="modal"
        ...
        <!-- <div class="col-sm-3">
                    <div class="custom-card bg-white box-shadow bt-5">
                        ...
                        <p class="text-center" id="selengkapnya" onclick="showList(this);" data-target="#list-8">
                            Selengkapnya <i class="fa fa-angle-down"></i></p>
                        <p class="text-center lebih-sedikit" id="lebih-sedikit" data-target="#list-8"
                           style="display:none;" onclick="hideList(this);">Lebih sedikit <i class="fa fa-angle-up"></i>
                        </p>
                        <div class="text-center">
                            <a class="btn btn-filled font-size-11 mb20-xs mb20" href="#" data-toggle="modal"
    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                <!--            Selengkapnya <i class="fa fa-angle-down"></i></p>-->
                <!--        <p class="text-center lebih-sedikit" id="lebih-sedikit" data-target="#list-9"-->
                <!--           style="display:none;" onclick="hideList(this);">Lebih sedikit <i class="fa fa-angle-up"></i>-->
                <!--        </p>-->
                <!--        <div class="text-center">-->
                <!--            <a class="btn btn-filled font-size-11 mb20-xs mb20" href="#" data-toggle="modal"-->
                <!--               data-target="#proposal_new_product"> Minta Proposal </a>-->
                <!--        </div>-->
                <!--    </div>-->
                <!--</div>-->
                ...
                <div class="col-sm-4">
                    <div class="custom-card box-shadow bt-5">
                        <div class="card-body-normal text-center">
                            ...
                            <img src="img/redesign/icon/pt_full_flat.png" width="100" class="mb10">
                            <h5 class="mb0">Mulai Dari</h5>
                            <h4 class="montserrat-600 color-grey mt10">IDR 3 JT</h4>
                        </div>
                        <ul class="text-left color-softgrey lists">
                            <li>
                                <p>
