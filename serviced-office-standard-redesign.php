        ...
        <ul class="slides">
            <li class="image-bg pt-xs-120">
                <div class="background-image-holder">
                    <img alt="image" class="background-image" src="img/redesign/headerservices-51.jpg">
                </div>
                <div class="container v-align-transform">
                    <div class="row text-left">
                        <div class="col-md-6 mt88-lg mt-xs-30 pt-xs-64 ">
                          <h1 class="bold mb0"> Standard  </h1>
                ...
                <div class="col-sm-12">
                      <div class="col-sm-6">
                       <div class="hr mb20-lg mb10-xs"></div>
                        ...
                        <h5 class="padding-5 mb5">Conveniently located with affordable price, our standard office space plan is an ideal choice to help kick-start your business in a smart and efficient way. Leaving you with no hassle for fit-outs, initial high startup costs or other tribulations of traditional leased office, so you can fully focus on your business growth.</h5>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 mb40 text-center">
                    ...
                    <h5 class="mb20">of Standard Plan</h5>  
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 mb20">
                    <div class="col-sm-2 col-xs-6 text-center mb20">
                        ...
                        <div class="col-sm-2 col-xs-6 text-center mb20">
                            ...
                            <p class="color-black bold" key="sectionplannin11"> Free call transfer service</p>
                        </div>
                ...
                <div class="col-sm-12">
                    <div class="col-md-2 col-xs-6 text-center mb20">
                        ...
                        <div class="col-md-2 col-xs-6 text-center mb20">
                            ...
                            <p class="color-black bold" key="sectionplannine16">Meeting room usage every month</p>
                        </div>

                        <div class="col-md-2 col-xs-6 hidden-xs text-center mb20">
                            <img src="img/material/high.png " width="50px">
                            <p class="color-black bold" key="sectionplannine15">Free wi-fi in all <br> office area</p>
                        </div>
                        <div class="col-md-2 col-xs-6 hidden-xs text-center mb20">
