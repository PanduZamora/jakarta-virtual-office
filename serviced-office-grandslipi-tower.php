...
<head>
    <meta charset="utf-8">
    <title>Office Space Slipi, Serviced Office Grand Slipi Tower</title>

    <meta name="description" content="Office Space Slipi S Parman, Private Office, Serviced Office Grand Slipi Tower" />
            ...
            <ul class="slides">
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="img/serviced-office/gst-so.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="mbmin-1 mb-xs-32 large mt12 mt-xs-0">Serviced Office</h1>
                                <h1 class="mbmin-1 mb-xs-16 large mt-xs-0">Grand Slipi Tower</h1>
                                <h6 class="uppercase mb0">Level 42G - H, Jl S Parman Kav 22 - 24, Slipi</h6>
                                <h6 class="uppercase mb20">Jakarta Barat 11480</h6>
                ...
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="virtual office kencana tower" class="background-image" src="img/locations/grandslipi-tower/gst-meet.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        ...
                        <p>
                            At vOffice - Grand Slipi Building center, we take pride in serving our clients with outmost care and professionalism.
                        </p>
                        <hr>
                        ...
                        <table class="table table-blank">
                            <thead>
                                <tr>
                                    <th colspan="2">Establishments close to Grand Slipi Building</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>Ibis Jakarta Slipi</li>
                                            <li>Hotel Santika Premier Slipi</li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="img/locations/grandslipi-tower/gst-floor.png">
                                    </td>
                    ...
                    <div class="col-sm-6 col-md-5 col-md-offset-1 mt24 mt-xs-64">
                        ...
                        <div class="iframe-container mb24">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.475535665468!2d106.79633351476897!3d-6.200823495511043!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f6bef76d73c7%3A0x9a7bd46f9c165eda!2sGrand+Slipi+Tower%2C+Jl.+Letjen+S.+Parman+No.22-24%2C+Palmerah%2C+Kota+Jakarta+Barat%2C+Daerah+Khusus+Ibukota+Jakarta+11480!5e0!3m2!1sen!2sid!4v1518676170774" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>
                        <div class="feature bordered">
                            <h4 class="bold">Contact Us</h4>
                            <p class="mb0">Grand Slipi Tower</p>
                            <p class="mb0">Level 42G - H, Jl S Parman Kav 22 - 24, Slipi Jakarta Barat, 11480, Indonesia</p>
                            <p>Jakarta Barat, 11480, Indonesia</p>
                                ...
                                <div class="image-tile hover-tile text-center">
                                    ...
                                    <div class="hover-state">
                                        <a>
                                            ...
                                            <h6 class="uppercase">Grand Slipi Tower</h6>
                                        </a>
                                    </div>
                                </div>
