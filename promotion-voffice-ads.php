                ...
                <div class="container v-align-transform">
                    <div class="row text-left">
                        <div class="col-md-10 mt88 mt-xs-36">
                            <h4 class="mb8 number bold uppercase">Virtual Office Special Deals</h4>
                            <h2 class="mb8 number pt-xs-36">Get up to <b>18 Juta</b> Special Rewards + Extra Reward for 24 months plan </h2>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="col-sm-6 mb20">
                        <img src="img/popup/promo-desember-min.jpg">
                    </div>
                    <div class="col-sm-6">
