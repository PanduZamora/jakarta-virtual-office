...
<head>
    <meta charset="utf-8">
    <title>Sewa Meeting Room Jakarta Utara, Kelapa Gading, Kirana 2 Tower</title>

    <meta name="description" content="Sewa Ruang Rapat, Ruang Meeting, Meeting Room, Jakarta Timur, Kirana 2 Tower, Kelapa Gading, vOffice Indonesia, Jakarta Virtual Office, Jakarta Serviced
            ...
            <ul class="slides">
                <li class="overlay image-bg pt-xs-120">
                    ...
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="mb40 mb-xs-16 large mt64 mt-xs-0">Kirana Two Office Tower</h1>
                                <h6 class="uppercase mb0">Level 10, Jl Boulevard Timur No.88 Kelapa Gading</h6>
                ...
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="virtual office kencana tower" class="background-image" src="img/locations/kirana2-tower/kirana-lounge.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                ...
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="virtual office kencana tower" class="background-image" src="img/locations/kirana2-tower/kirana-so.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="bold title">Kirana 2 Tower</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <img class="mt80 mt-xs-0 mb24" alt="Pic" src="img/locations/kirana2-tower/kir-meet.jpg">
                                        <img class="col-md-pull-4 relative mb24" alt="Pic" src="img/locations/kirana2-tower/kirana-lounge.jpg">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="iframe-container mb24">
                                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.7448553159434!2d106.91203561406736!3d-6.164913662133255!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e698ad2eef61e0f%3A0xcc11b45554e76f6f!2sKirana+Two+Office+Tower!5e0!3m2!1sid!2sid!4v1503914684480" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                                    </div>

                                </div>
                                <div class="col-md-6">
                                    <h4 class="bold">Contact Us</h4>
                                    <p class="mb0">Kirana Two Office Tower</p>
                                    <p class="mb0">Level 10, Jl Boulevard Timur No.88 Kelapa Gading</p>
                                    <p>Jakarta Utara, 14250, Indonesia</p>
