...
<head>
    <meta charset="utf-8">
    <title>Promotion vOffice New Location Serviced Office</title>

    <meta name="description" content="Promo Serviced Office vOffice"/>
    ...
    <style media="screen">
        ...
        .owl-dot {
            ...
            border: 0px;
            border-radius: 50%;
            background: rgb(212, 208, 208) !important;
        }

        .owl-dots .active {
            background: rgb(135, 131, 131) !important;
        }
    </style>
</head>
<body>
                ...
                <div class="container v-align-transform">
                    <div class="row text-left">
                        <div class="col-md-10 mt88 mt-xs-36">
                            <h4 class="mb8 number bold uppercase">Sign Now Pay Later !</h4>
                            <h2 class="mb8 number pt-xs-36">Up to <b>50% Off</b> For Serviced Office vOffice </h2>
                            ...
                            <p class="small pb-xs-16 mb0">(Promo Valid until 31 Mei 2020)</p>
...
<!--                        productivity! </h4>-->
                ...
                <div class="col-sm-12">
                    <div class="col-sm-6 mb20">
                        <img src="images/promo-all-so.jpg" class="border-radius-5">
                    </div>
                    <div class="col-sm-6">
                        <div class="feature boxed3">
                            <h4 class="mb8 bold text-center color-black">Daftar Sekarang</h5>
                                ...
                                <form class="form-email"
                                    ...
                                    <input type="text" name="promotion-new-location" hidden="hidden"
                                           value="promotion-new-location"
                                           id="promotion-new-location">
