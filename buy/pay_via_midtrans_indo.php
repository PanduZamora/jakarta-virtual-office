...
<pre>
  <form action="token-checkout_midtrans.php" method="POST" id="payment-form" hidden="hidden">
        ...
        <input type="checkbox" name="secure" value="true" checked hidden="hidden">
        <input type="checkbox" name="save_cc" value="true" checked hidden="hidden">
		<input name="ref" id="ref" value="<?=$ref_id?>"  hidden="hidden"/>
     	<input class="card-price" name="price" id="price" value="<?=$_SESSION["stotal"]?>"  hidden="hidden"/>
     	<input name="item" id="item" value="<?=$_SESSION["in_plan"]?>"  hidden="hidden"/>
