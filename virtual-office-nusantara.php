...
<head>
  <meta charset="utf-8">
  <title>Bisnis Kamu Mau Buka Cabang? Virtual Office vOffice</title>

  <meta name="description" content="Lindungi Bisnis Anda Beralih ke Virtual Office Terbaik di Indonesia Sekarang" />
...
<body class="location-detail">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-5">
          <div class="desc">
            <h1 class="title em">
              <span class="tt-n">Bisnis Kamu Mau Buka Cabang?</span>
              <span class="em-purple">Virtual Office vOffice</span>
            </h1>
            <div class="slider-nusantara hide-pc">
              <img src="assets/img/nusantara/buka_cabang.png" alt="" class="img-fluid">
              <img src="assets/img/nusantara/hemat_biaya.png" alt="" class="img-fluid">
              <img src="assets/img/nusantara/kantor_prestisius.png" alt="" class="img-fluid">
              <img src="assets/img/nusantara/3.png" alt="" class="img-fluid">
              <img src="assets/img/nusantara/4.png" alt="" class="img-fluid">
              <img src="assets/img/nusantara/5.png" alt="" class="img-fluid">
            </div>
        ...
        <div class="col-md-7">
          <div class="slider-nusantara hide-mobile">
            <img src="assets/img/nusantara/buka_cabang.png" alt="" class="img-fluid">
            <img src="assets/img/nusantara/hemat_biaya.png" alt="" class="img-fluid">
            <img src="assets/img/nusantara/kantor_prestisius.png" alt="" class="img-fluid">
            <img src="assets/img/nusantara/3.png" alt="" class="img-fluid">
  ...
  <section class="service-section p_relative sec-pad centred" id="section4" style="background-image: url('img/new/bg-jakarta.jpg'); background-position: fixed;">
    <div class="auto-container">
      ...
      <div class="row mt-5">
        <div class="col-md-12">
          <a href="http://bit.ly/sem-voffice" class="link-changer">
            <img src="assets/img/nusantara/2.png" alt="" class="img-fluid">
          </a>
        </div>
      </div>
    </div>
