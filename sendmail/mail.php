...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['Schedule_a_Visit'] != "") {
    ...
    $mail->AddCC('astrid.voffice@gmail.com');
    $mail->AddBCC('albert.g@voffice.com.my');
    $mail->AddBCC('kevin.voffice@gmail.com');
    $mail->AddBCC('adam.goh@voffice.co.id');
    $mail->AddBCC('panduzamora.voffice@gmail.com', 'Web Developer');
    $mail->AddBCC('dian@voffice.co.id');
    $mail->AddBCC('cs@voffice.co.id');
    if ($mail->Send()) {
        echo "2";
    } else {
...
//Promo Serviced Office BSD
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['notifyme'] != "") {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['virtualoffice'] != "") {
    ...
    $mail->AddBCC('panduzamora.voffice@gmail.com');
    if ($mail->Send()) {
        echo "2";
    } else {
        echo "Mailer Error: " . $mail->ErrorInfo;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['virtualoffice_fbigads'] != "") {
    ...
    $mail->MsgHTML($message);
    $mail->AddAddress('mia@voffice.co.id', 'Customer Service');
    $mail->AddBCC('kevin.voffice@gmail.com');
    $mail->AddBCC('cs@voffice.co.id');
    $mail->AddBCC('rifda.voffice@gmail.com');
    $mail->AddBCC('adam.goh@voffice.co.id');
...
// New Serviced Office Page | Serviced office di jakarta
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['promo_so'] != "") {
...
//Home Business Landing Page
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['virtualoffice-4.0'] != "") {
