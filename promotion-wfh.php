                ...
                <div class="container v-align-transform">
                    <div class="row text-left">
                        <div class="col-md-10 mt88 mt-xs-36">
                            <h4 class="mb8 number bold uppercase">Support Your <b>#WorkFromHome</b></h4>
                            <h2 class="mb24 number pt-xs-36">With Virtual Office </h2>
                            ...
                            <p class="small pb-xs-16 mb0">(Promo Valid until 30 April 2020)</p>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="col-sm-6 mb20">
                        <img src="img/popup/promo-wfh.jpeg">
                    </div>
                    <div class="col-sm-6">
                        <div class="feature boxed3">
                            <h4 class="mb8 bold text-center color-black">Daftar Sekarang</h5>
                                ...
                                <form class="form-email"
                                    ...
                                    <input type="text" name="promo-wfh" hidden="hidden"
                                           value="promo-wfh"
