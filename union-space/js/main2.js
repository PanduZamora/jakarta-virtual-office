...
$(document).ready(function(){
  ...
  setTimeout(function(){
   if ($(window).width() > 900 && window.location.href !== "https://izin.co.id/bisnis-di-rumah.php"){
...
(function ($) {
  ...
  $(window).scroll(function() {
    if ($(this).scrollTop() > 40) {
      ...
      $('#collapse-header').removeClass('container-fluid2');
      $('#collapse-header').addClass('container-fluid');
    } else {
      $('#header').removeClass('header-scrolled');
      $('#collapse-header').removeClass('container-fluid');
      $('#collapse-header').addClass('container-fluid2');
    }
  });
