...
<head>
    ...
    <title>Sewa Meeting Room Jakarta - Murah & Fasilitas Lengkap | vOffice™</title>

    <meta name="description" content="Sewa Meeting Room / Ruang Rapat di Jakarta ✅ Fasilitas Lengkap ✅
    Free Wifi ✅ LCD TV ✅ Projector and Screen ✅ White Board & Color Markers ✅" />
    ...
    <div class="main-container">
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="image-slider slider-arrow-controls controls-inside" style="margin-top:10px;">
                            <ul class="slides">
                                <li>
                                    <img class="mb8" alt="Screenshot" src="img/meeting-room/gs-meet.jpg">
                                </li>
                                <li>
                                    <img class="mb8" alt="Screenshot" src="img/meeting-room/gst-meet.jpg">
                                </li>
                                <li>
                                    <img class="mb8" alt="Screenshot" src="img/meeting-room/kir-meet.jpg">
                                </li>
                                <li>
                                    <img class="mb8" alt="Screenshot" src="img/meeting-room/kt-meet.jpg">
                                </li>
                                <li>
                                    <img class="mb8" alt="Screenshot" src="img/meeting-room/mr-meet.jpg">
                                </li>
                                <li>
                                    <img class="mb8" alt="Screenshot" src="img/meeting-room/mt-meet.jpg">
                                </li>
                                <li>
                                    <img class="mb8" alt="Screenshot" src="img/meeting-room/off-meet.jpg">
                                </li>
                                <li>
                                    <img class="mb8" alt="Screenshot" src="img/meeting-room/pik-meet.jpg">
                                </li>
                                <li>
                                    <img class="mb8" alt="Screenshot" src="img/meeting-room/tct-meet.jpg">
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-8">
                        <h2 class="bold">Meeting Room & Conference Room</h2>
                        <div class="hr mb40 left"></div>
                        <h5 class="mb40 color-black text-left article">
                            vOffice has meeting room options which are ideal for start-up and established professionals to
                            host meetings and conference with potential partners.
                            Our meeting rooms are located at prestigious easy-to-access locations and well equipped with all
                    ...
                    <div class="col-sm-3 mb20 mt30">
                        <div class="col-sm-12 card-plan pt text-center">
                            <h3 class="bold color-primary mb0"> PLAN 1 </h3>
                            <h5 class="mb10">Hourly</h5>
                            <hr class="mb10">
                    ...
                    <div class="col-sm-3 mb20 mt30">
                        <div class="col-sm-12 card-plan pt text-center">
                            <h3 class="bold color-primary mb0"> PLAN 10 </h3>
                            <h5 class="mb10">10 Hours</h5>
                            <hr class="mb10">
                            <h4 class="mb0"> Only </h4>
                    ...
                    <div class="col-sm-3 mb20 mt30">
                        <div class="col-sm-12 card-plan pt text-center">
                            <h3 class="bold color-primary mb0"> PLAN 30 </h3>
                            <h5 class="mb10">30 Hours</h5>
                            <hr class="mb10">
                            <h4 class="mb0"> Only </h4>
                    ...
                    <div class="col-sm-3 mb20 mt30">
                        <div class="col-sm-12 card-plan pt text-center">
                            <h3 class="bold color-primary mb0"> PLAN 50 </h3>
                            <h5 class="mb10">50 Hours</h5>
                            <hr class="mb10">
                            <h4 class="mb0"> Only </h4>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <h2 class="bold mb30"> Amenities </h2>
                ...
                <div class="row mb20">
                    <div class="col-sm-12">
                        <div class="col-sm-4 text-center">
                            <img src="img/redesign/icon/meeting_room/wifi.png" class="mb10" width="20%">
                            <h5 class="color-black"> Free Wifi</h5>
                        </div>
                        <div class="col-sm-4 text-center">
                            <img src="img/redesign/icon/meeting_room/tv.png" class="mb10" width="20%">
                            <h5 class="color-black">LCD TV</h5>
                        </div>
                        <div class="col-sm-4 text-center">
                            <img src="img/redesign/icon/meeting_room/projector.png" class="mb10" width="20%">
                            <h5 class="color-black"> Projector and Screen</h5>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-4 text-center">
                            <img src="img/redesign/icon/meeting_room/board.png" class="mb10" width="20%">
                            <h5 class="color-black"> White Board & Color Markers</h5>
                        </div>
                        <div class="col-sm-4 text-center">
                            <img src="img/redesign/icon/meeting_room/tea.png" class="mb10" width="20%">
                            <h5 class="color-black">Free Flow Refreshment</h5>
                        </div>
                        <div class="col-sm-4 text-center">
                            <img src="img/redesign/icon/meeting_room/catering.png" class="mb10" width="20%">
                            <h5 class="color-black">Optional Catering Service</h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section>
            <div class="col-sm-12 col-md-12">
                <div class="text-center">
                    <h4 class="bold lang" id="location-title" key="locationindex">Jakarta</h4><br><br>
                </div>
            </div>
            <div class="col-md-8">
                <div class="row">
                    <div class="col-sm-12 padding-left-50">
                        ...
                        <div class="col-md-6 text-left mb30 jakarta south-jakarta city-content">
                            <div class="mr-wrapper">
                                <p class="h4">Meeting Room <br>@ GKM Green Tower</p>
                                <div class="mr-image">
                                    <img src="img/tower/GKM-tower/jpg/5.jpg" />
                                </div>
                                <p class="bold">Capacity</p>
                                <p class="p">10pax</p><!-- 10pax -->
                                <hr>
                        ...
                        <div class="col-md-6 text-left mb30 jakarta south-jakarta city-content">
                            <div class="mr-wrapper">
                                <p class="h4">Meeting Room <br>@ Metropolitan Tower</p>
                                <div class="mr-image">
                                    <img src="img/tower/metropolitan-tower/jpg/3.jpg" />
                                </div>
                                <p class="bold">Capacity</p>
                                <p class="p">10 Pax</p><!-- 10pax -->
                                <hr>
                                <p class="bold">Size</p>
                                <p class="p">17 Sqm</p><!-- 24 Sqm -->
                                <hr>
                        ...
                        <div class="col-md-6 text-left mb30 jakarta south-jakarta city-content">
                            <div class="mr-wrapper">
                                <p class="h4">Meeting Room <br>@ Menara Rajawali</p>
                                <div class="mr-image">
                        ...
                        <div class="col-md-6 text-left mb30 jakarta central-jakarta city-content">
                            <div class="mr-wrapper">
                                <p class="h4">Meeting Room <br>@ MRT Business Space</p>
                                <div class="mr-image">
                                    <img src="img/tower/mrt-business-space/jpg/5.jpg" />
                                </div>
                                <p class="bold">Capacity</p>
                        ...
                        <div class="col-md-6 text-left mb30 jakarta central-jakarta city-content">
                            <div class="mr-wrapper">
                                <p class="h4">Meeting Room <br>@ Citra Tower Kemayoran</p>
                                <div class="mr-image">
                                    <img src="img/tower/citra-tower/1.jpeg" />
                                </div>
                                <p class="bold">Capacity</p>
                        ...
                        <div class="col-md-6 text-left mb30 jakarta south-jakarta city-content">
                            <div class="mr-wrapper">
                                ...
                                <div class="mr-image">
                                    <img src="images/SO/Office 8/Conference Room 1.jpg" />
                                </div>
                                <p class="bold">Capacity</p>
                                <p class="p">14 Pax</p>
                                <hr>
                        ...
                        <div class="col-md-6 text-left mb30 jakarta south-jakarta city-content">
                            <div class="mr-wrapper">
                                ...
                                <div class="mr-image">
                                    <img src="images/SO/Centennial/Conference Room 1.jpg" />
                                </div>
                                <p class="bold">Capacity</p>
                                <p class="p">20 Pax</p>
                                <hr>
                        ...
                        <div class="col-md-6 text-left mb30 tangerang city-content" style="display:none;">
                            <div class="mr-wrapper">
                                <p class="h4">Meeting Room <br>@ The Prominence Tower</p>
                                <div class="mr-image">
                                    <img src="img/tower/prominence-tower/jpg/19.jpg" />
                                </div>
                                <p class="bold">Capacity</p>
                                <p class="p">10 Pax</p><!-- 10 Pax -->
                                <hr>
                                <p class="bold">Size</p>
                                <p class="p">17 Sqm</p><!-- 12 Sqm -->
                                <hr>
                                <p class="bold">Price</p>
                                <p class="p">IDR 255.000/Hour</p> <!-- IDR 250.000/Hour -->
                                <hr>
                        ...
                        <div class="col-md-6 text-left mb30 bekasi city-content">
                            <div class="mr-wrapper">
                                <p class="h4">Meeting Room <br>@ Plaza Summarecon Bekasi</p>
                                <div class="mr-image">
                                    <img src="images/lokasi-gedung-voffice/bekasi/meeting-room.jpg" />
                                </div>
                                <p class="bold">Capacity</p>
                                <p class="p">10 Pax</p>
                                <hr>
                        ...
                        <div class="col-md-6 text-left mb30 cibubur city-content">
                            <div class="mr-wrapper">
                                <p class="h4">Meeting Room <br>@ Mensana Tower</p>
                                <div class="mr-image">
                                    <img src="images/3d-cibubur/C7.jpeg" />
                                </div>
                                <p class="bold">Capacity</p>
                                <p class="p">10 Pax</p>
                                <hr>
                        ...
                        <div class="col-md-6 text-left mb30 jakarta north-jakarta city-content">
                            <div class="mr-wrapper">
                                ...
                                <div class="mr-image">
                                    <img src="images/3d-pluit/MEETING ROOM - REV 2.jpg" />
                                </div>
                                <p class="bold">Capacity</p>
                                <p class="p">10 Pax</p>
                                <hr>
