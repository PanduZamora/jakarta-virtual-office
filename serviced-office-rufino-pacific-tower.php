...
<head>
    <meta charset="utf-8">
    <title>Office Space Ayala Avenue Makati Filipina, Serviced Office Rufino Pacific Tower</title>

    <meta name="description" content="Office Space Ayala Avenue Makati Filipina, Private Office, Serviced Office Rufino Pacific Tower" />
            ...
            <ul class="slides">
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_ph/rufino_pacific_tower/ruf-gallery4.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-8 col-sm-8">
                                <h1 class="mb40 mb-xs-16 large mt64 mt-xs-0">Rufino Pacific Tower</h1>
                                <h6 class="uppercase mb0">6784 Ayala Avenue corner V.A.</h6>
                                <h6 class="uppercase mb40">Rufino, Makati City, Philippines</h6>
                ...
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_ph/rufino_pacific_tower/ruf-gallery3.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-8 col-sm-8">
                ...
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_ph/rufino_pacific_tower/ruf-gallery2.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-8 col-sm-8">
            ...
            <div class="container">
                                ...
                                <div class="image-tile hover-tile text-center">
                                    ...
                                    <div class="hover-state">
                                        <a>
                                            ...
                                            <h6 class="uppercase">Rufino Pacific Tower</h6>
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        ...
                        <hr class="title-breaker left">
                        <p>
                            At vOffice - Rufino Pacific Tower center, we take pride in serving our clients with outmost care and professionalism.
                        </p>
                        <hr>
                        ...
                        <table class="table table-blank">
                            <thead>
                                <tr>
                                    <th colspan="2">Establishments close to Rufino Pacific Tower</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>Manila Peninsula</li>
                                            <li>Shangri-La Makati</li>
                                            <li>Holiday Inn</li>
                                            <li>New World Hotel</li>
                                            <li>Raffles Hotel</li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>SSS Makati Building</li>
                                            <li>Ayala Museum</li>
                                            <li>Greenbelt</li>
                                            <li>Glorietta</li>
                                            <li>The SM Department Store</li>
                                            <li>Fitbox Gym</li>
                                            <a href="https://goo.gl/maps/yzRz67RuU152" target="_blank">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="iframe-container mb24">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3861.719172649859!2d121.01603066408398!3d14.558045232022867!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397c90ecf32aa17%3A0x180ad2840b3231a7!2sRufino+Pacific+Tower%2C+6784+Ayala+Ave%2C+Legazpi+Village%2C+Makati%2C+Metro+Manila%2C+Filipina!5e0!3m2!1sid!2sid!4v1513762546007" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>

                    </div>
                    <div class="col-md-6">
                        <h4 class="bold">Contact Us</h4>
                        <p class="mb0">Rufino Pacific Tower</p>
                        <p class="uppercase mb0">6784 Ayala Avenue corner V.A.</p>
                        <p class="mb0">Rufino, Makati City, Philippines</p>
