...
<head>
    ...
    <style media="screen">
        ...
        .parallax {
            ...
            padding-top: 70px;
            padding-bottom: 70px;
            background: url(img/new/bg-jakarta.jpg) no-repeat center center;
...
<body>
    ...
    <div class="main-container">
        ...
        <section class="top-header text-left" style="background:url(img/bg/live@voffice.jpg) no-repeat center center fixed;">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <h1 class="color-white bold mb8">Live @ vOffice</h1>
                        <h5 class="color-white">Bring Your Events to Live</h5>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-sm-7">
                        <h3 class="montserrat-bold bold" style="margin-top:50px;">Apa itu Live @ vOffice?</h3>
                        <p class="open-sans custom-article color-black">
                            Live @ vOffice adalah ruang studio multifungsi dengan fasilitas dan peralatan rekaman lengkap yang dapat digunakan sebagai ruang podcast atau event online dan ideal bagi kalangan profesional maupun non-profesional.
                        </p>
                    </div>
                    <div class="col-sm-5">
                        ...
                        <div class="image-slider slider-arrow-controls controls-inside">
                            <ul class="slides">
                                <li>
                                    <img src="img/live-at-voffice/2.jpg" width="100%" style="border-radius:15px;">
                                </li>
                                <li>
                                    <img src="img/live-at-voffice/3.jpg" width="100%" style="border-radius:15px;">
                                </li>
                                <li>
                                    <img src="img/live-at-voffice/4.jpg" width="100%" style="border-radius:15px;">
                                </li>
                                <li>
                                    <img src="img/live-at-voffice/5.jpg" width="100%" style="border-radius:15px;">
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <section>
            <div class="container">
                <div class="row mb56">
                    <div class="col-sm-12">
                        <h2 class="text-center bold">Apa yang tersedia di Live @ vOffice?</h2>
                        <p class="text-center text-muted">Ruang Live @ vOffice dilengkapi dengan set peralatan rekaman lengkap untuk mengakomodir kebutuhan Anda.</p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xs-6 col-md-3 text-center mb56">
                        <div class="">
                            <img src="https://img.icons8.com/dusk/64/000000/wifi.png" class="mb32" />
                            <h5 class="mb10 bold text-secondary">High Speed Internet<br><br></h5>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-3 text-center mb56">
                        <div class="">
                            <img src="https://img.icons8.com/dusk/64/000000/monitor.png" class="mb32" />
                            <h5 class="mb10 bold text-secondary">LCD TV<br><br></h5>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-3 text-center mb56">
                        <div class="">
                            <img src="https://img.icons8.com/dusk/64/000000/coffee.png" class="mb32" />
                            <h5 class="mb10 bold text-secondary">Free Flow Refreshment<br><br></h5>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-3 text-center mb56">
                        <div class="">
                            <img src="https://img.icons8.com/dusk/64/000000/light.png" class="mb32" />
                            <h5 class="mb10 bold text-secondary">Lighting<br><br></h5>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-3 text-center mb56">
                        <div class="">
                            <img src="https://img.icons8.com/dusk/64/000000/computer.png" class="mb32" />
                            <h5 class="mb10 bold text-secondary">Green Screen<br><br></h5>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-3 text-center mb56">
                        <div class="">
                            <img src="https://img.icons8.com/dusk/64/000000/glasses.png" class="mb32" />
                            <h5 class="mb10 bold text-secondary">Virtual Stage<br><br></h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section>
            <div class="container-fluid" style="padding:0;">
                <div class="row">
                    <div class="col-sm-7">
                        <img src="img/live-at-voffice/6.jpg" width="100%" style="border-top-right-radius:15px;border-bottom-right-radius:15px;box-shadow:0px 10px 30px -1px rgba(41, 35, 88, 0.45) !important">
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="box">
                            <div class="text-center">
                                <img src="img/live-at-voffice/other_service.svg" class="mb32">
                            </div>
                            ...
                            <ul class="box-feature">
                                ...
                                <li>
                                    <i class="ti-check text-success"></i>
                                    Virtual Stage <span class="badge badge-warning text-white">New</span>
                                </li>
                            </ul>
                            <div class="text-center">
                                <a href="https://bit.ly/ChatHellolive" class="btn btn-success">
                    ...
                    <div class="col-sm-4">
                        <div class="box">
                            <div class="text-center">
                                <img src="img/live-at-voffice/live_stream_room.svg" class="mb32">
                            </div>
                            <h4 class="color-primary bold text-uppercase text-center">Live Streaming Room</h4>
                            ...
                            <ul class="box-feature">
                                ...
                                <li>
                                    ...
                                    Online Event Equipment Set <br>
                                    <span class="text-secondary small">
                                        (Webcams, Camera, Mixer, Sound Card
                                        Behringer, Clip on Saramonic,
                                        Mix Podcast, Earphone, Switcher
                                        Device Well, Green Screen, Digital Led
                                        Clock Coundown Timer)
                                    </span>
                                </li>
                                <li>
                                    <i class="ti-check text-success">
                                    </i>
                                    Studio Layout Decoration
                                </li>
                                <li>
                                    <i class="ti-check text-success">
                                    </i>
                                    Technical support pre event
                                </li>
                            </ul>
                            <div class="text-center">
                                <a href="https://bit.ly/ChatHellolive" class="btn btn-success">
                    ...
                    <div class="col-sm-4">
                        <div class="box">
                            <div class="text-center">
                                <img src="img/live-at-voffice/event_stream_room.svg" class="mb56">
                            </div>
                            <h4 class="color-primary bold text-uppercase text-center">Event Streaming Room</h4>
                            <h5 class="bold text-center">IDR 2.000.000 / Hour</h5>
                            <ul class="box-feature">
                                <li>
                                ...
                                <li>
                                    <i class="ti-arrow-circle-right text-success"></i>
                                    Covered Chairs & desks
                                </li>
                                <li>
                                    <i class="ti-arrow-circle-right text-success"></i>
                                    2 units projectors + screen
                                </li>
                                <li>
                                    <i class="ti-arrow-circle-right text-success"></i>
                                    Soundsystem + 2 microphones
                                </li>
                                <li>
                                    <i class="ti-arrow-circle-right text-success"></i>
                                    Zoom meeting capacity 500 pax
                                </li>
                            </ul>
                            <div class="text-center">
                                <a href="https://bit.ly/ChatHellolive" class="btn btn-success">
                ...
                <div class="row">
                    ...
                    <div class="col-md-offset-3 col-md-6 well bg-white">
                        ...
                        <p class="text-center bold"><span style="color: green" class="fab fa-whatsapp"></span>
                            Whatsapp
                            Number :
                            <a href="tel:+6281399333265"> +62 8139 - 9333 - 265</a>
                        </p>
                        ...
                        <form class="form-email" data-success="Thanks for your submission, we will be in touch shortly." data-error="Please fill all fields correctly.">
                            <input type="text" name="hellolive_inquiry" hidden="hidden" value="hellolive_inquiry" id="hellolive_inquiry">
        ...
        <a href="https://bit.ly/ChatHellolive" class="back-to-top" target="_blank"><i class="fab fa-whatsapp fa-2x"></i></a>
                    ...
                    <div class="col-md-4">
                        <form class="halves form-newsletter" data-error="Please fill all fields correctly." data-success="Thanks for your submission, you will be notified of Virtual Office Indonesia offers.">
                            <label class="lang" key="footerone3">
                                Daftar untuk mendapatkan Update Promo, Diskon & Penawaran Menarik dari vOffice
                            </label>
                            <div class="p0">
                        ...
                        <div class="col-sm-12">
                            ...
                            <p class="text-justify" id="about-voffice">
                                <span class="sub lang" key="footerone4">
                                    Sejak 2003, Virtual Office Indonesia (vOffice) telah melayani lebih dari 35.000 bisnis
                ...
                <div class="row fade-half">
                    <div class="col-md-9 col-sm-12">
                        <span class="sub">
                            ...
                            ,
                            <a href="https://unionspace.id" target="_blank">
                                Flexible Offices & Workspaces — Jakarta
                            </a>
                            ,
                            <a href="https://unionspace.co.th" target="_blank">Coworking & Workspace in Bangkok</a>
                            ,
                            <a href="https://unionspace.id/virtual-office-jakarta.php" target="_blank">Virtual Office Satrio
                                Tower</a>
                        </span>
                    </div>
        ...
        <div class="footer_bottom visible-xs visible-sm" style="margin-bottom:-50px;">
            <div class="footer_mobile_cta">
                <ul>
                    <li style="background: #25d366"><a href="https://bit.ly/ChatHellolive" id="waButton">
                            <h6 style="color: #fff" class="uppercase"><i class="fab fa-whatsapp fa-lg mr-10"></i>WhatsApp </h6>
                        </a>
                    </li>
                    <li style="background: #951942"><a href="mailto:asti@voffice.co.id">
        ...
        <!-- Hotjar Tracking Code for http://voffice.co.id/jakarta-virtual-office/ -->
        <script>
        ...
        <script>
            ...
            fbq('init', '651215832019051');
            fbq('track', 'PageView');
        </script>
        <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=651215832019051&ev=PageView&noscript=1" /></noscript>
        <!-- End Facebook Pixel Code -->

        <script type="text/javascript">
            (function() {
                window['gobot'] = window['gobot'] || function() {
                    (window['gobot'].queue = window['gobot'].queue || []).push(arguments)
                }
