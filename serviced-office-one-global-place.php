...
<head>
    <meta charset="utf-8">
    <title>Office Space in Taguig Philippines, Serviced Office One Global Palace</title>

    <meta name="description" content="Office Space in Taguig Philippines, Private Office, Serviced Office One Global Palace"/>
                ...
                <ul class="slides">
                    <li class="overlay image-bg">
                        <div class="background-image-holder">
                            <img alt="image" class="background-image" src="images/voffice_ph/one_global_place/ogp-gallery4.jpg">
                        </div>
                        <div class="container v-align-transform">
                            <div class="row">
                                <div class="col-md-8 col-sm-8">
                                    <h1 class="mb40 mb-xs-16 large mt64 mt-xs-0">One Global Place</h1>
                                    <h6 class="uppercase mb0">Level 10-1 & 20-1, 25th Street & 5th Avenue</h6>
                                    <h6 class="uppercase mb40">Bonifacio Global City, Taguig 1632 Philippines</h6>
                    ...
                    <li class="overlay image-bg">
                        <div class="background-image-holder">
                            <img alt="image" class="background-image" src="images/voffice_ph/one_global_place/ogp-gallery5.jpg">
                        </div>
                        <div class="container v-align-transform">
                            <div class="row">
                                <div class="col-md-8 col-sm-8">
                    ...
                    <li class="overlay image-bg">
                        <div class="background-image-holder">
                            <img alt="image" class="background-image" src="images/voffice_ph/one_global_place/ogp-gallery6.jpg">
                        </div>
                        <div class="container v-align-transform">
                            <div class="row">
                                <div class="col-md-8 col-sm-8">
        ...
        <div class="container">
                    ...
                    <div class="row masonry masonryFlyIn mb16">
                        <div class="col-sm-4 masonry-item project" data-filter="People">
                            <div class="image-tile hover-tile text-center">
                                <img alt="image" class="background-image" src="images/voffice_ph/one_global_place/ogp-gallery2.jpg">
                                <div class="hover-state">
                                    <a>
                                        <h3 class="uppercase mb8">Private Office</h3>
                                        <h6 class="uppercase">One Global Place</h6>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4 masonry-item project" data-filter="People">
                            <div class="image-tile hover-tile text-center">
                                <img alt="image" class="background-image" src="images/voffice_ph/one_global_place/ogp-gallery7.jpg">
                                <div class="hover-state">
                                    <a>
            ...
            <div class="row">
                        <div class="col-md-6 col-sm-6">
                            ...
                            <hr class="title-breaker left">
                             <p>
                                At vOffice - One Global Place center, we take pride in serving our clients with outmost care and professionalism.
                            </p>
                            <hr>
                            ...
                            <thead>
                            <tr>
                                <th colspan="2">Establishments close to One Global Place</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                ...
                                <li>Maybank</li>
                                <li>MetroBank</li>
                                <li>RCBC Savings Bank</li>
                                <li>Security Bank (Bancnet ATM)</li>
                                </ul>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                <ul>
                                <li>F1 Hotel Manila</li>
                                <li>Global City Hotel</li>
                                <li>Shangri-La</li>
                                </ul>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <li>Early Bird Breakfast Club</li>
                                <li>Starbucks Coffee</li>
                                <li>The Wholesome Table</li>
                                <li>Unit 27 Bar + Cafe</li>
                                </ul>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                <ul>
                                <li>Bonifacio High Street Central</li>
                                <li>Bonifacio High Street Cinema</li>
                                <li>Fitness First</li>
                                </ul>
            ...
            <div class="row">
                        ...
                        <div class="col-md-6">
                           ...
                           <iframe src="https://www.google.com/maps/embed?pb=!1m26!1m12!1m3!1d3861.8844436024638!2d121.04511626408382!3d14.548600132251048!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m11!3e6!4m3!3m2!1d14.549076399999999!2d121.04729959999999!4m5!1s0x3397c8efc663b4bd%3A0x2fd54c517460be9e!2sone+global+place!3m2!1d14.548255999999999!2d121.046959!5e0!3m2!1sid!2sid!4v1513758307975" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>

                        </div>
                        <div class="col-md-6">
                                  <h4 class="bold">Contact Us</h4>
                      <p class="mb0">One Global Place</p>
                                    <p class="uppercase mb0">Level 10-1 & 20-1, 25th Street & 5th Avenue</p>
                                    <p class="uppercase mb0">Bonifacio Global City, Taguig 1632 Philippines</p>

                        <ul class="social-list">
                            <li class="small">
                                <a href="tel:+62212242000">
                                    <i class="fa fa-phone"></i> <span>+6221 224 2000</span>
                                </a>
                            </li>
                            <li class="small">
                                <a href="mailto:cs@voffice.com.ph">
                                    <i class="ti-email"></i> <span>cs@voffice.com.ph</span>
                                </a>

                            </li>
                            <li class="small">
                                <a href="http://voffice.com.ph/" target="_blank">
                                    <i class="ti-world"></i> <span>www.voffice.com.ph</span>
                                </a>
                            </li>
                        </ul>
                        </div>
