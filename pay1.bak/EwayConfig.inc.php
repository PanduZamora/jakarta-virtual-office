<?php
        $eWAY_CustomerID = "14440882";    // Set this to your eWAY Customer ID
		$eWAY_TESTCustomerID = "91850143";    // Set this to your eWAY TEST Customer ID
		...
		$eWAY_TESTUseLive = false; // Set this to true to use the live gateway
	...
	//define('EWAY_DEFAULT_PAYMENT_METHOD', REAL_CVN); // possible values are: REAL_TIME, REAL_TIME_CVN, GEO_IP_ANTI_FRAUD
