...
<div id="showcase_clip"> 
  <div id="showcase"> 
    ...
    <div class="col1">
      ...
      <div class="rndbox3"> 
        <p><strong>This transaction is declined.</strong> There may be a problem 
          with the card or the card issuer did not authorize this transaction. 
          You may contact your card issuer to find out more about the error. Your 
          card issuer contact number is usually printed at the back of your credit 
          card.</p>
        <p>Alternatively, you may try again with another credit card or contact 
          us according to the information on the right hand side of this screen 
          to speak to one of our Client Service Executive. We also gladly accept 
          payment by way of Cheque, Direct Deposit, Cash, Paypal and Western Union.<br>
        </p>
      </div>
    </div>
