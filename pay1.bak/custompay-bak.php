...
/*
			...
			echo "plan is ".$plan. "<br>";
			echo "card is ".$price. "<br>";
			echo "date is ".$card_no. "<br>";
			echo "cvv is ".$card_cvv. "<br>";
	*/		
		...
		$vpc_MTxnRef=$ref_id;
			...
			*********************/
			...
			$gw_resp_code = $txnResponseCode;

			}

			$txnref = $gw_resp_code;
			$authcode = $authorizeID;
			//die();
