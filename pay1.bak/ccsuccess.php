...
<div id="showcase_clip"> 
  <div id="showcase"> 
    <h1>Credit Card Payment<br> Status: <strong>Success</strong></h1>
    <div class="col1">
        
      <div class="rndbox3"> 
        <p>Thank you for your payment. We appreciate your business.</p>
        <p>Our bank has successfully charged your credit card and this transaction 
          will appear as <strong>Flexi e-Solutions Pty Ltd</strong> on your credit 
          card statement.</p>
        <p>If you have any concern at all, feel free to contact us. You can reach 
          us according to the information on the right hand side of this screen.</p>
      </div>
    </div>
    ...
    <div class="col2"> 
      ...
      <div class="divider"> 
        ...
        <p> <img src="http://www.virtual-office.com.my/images/icon-phone.png"> 
          ...
          2788 3666<br>
          <img src="http://www.virtual-office.com.my/images/icon-email.png"> cs 
          @ vOffice.com.my</p>		  <p>&nbsp;</p>        <p><img src="https://virtual-office.com.my/pay/images/vOffice.png" width="116" height="40"></p>        <p><strong>Menara Rajawali, 7Fl</strong><br>          JL. Mega kuningan Lot No.5.1<br>          Setiabudi Jakarta Selatan 12950</p>        <p> <img src="http://www.virtual-office.com.my/images/icon-phone.png">           +62812 1020 1211<br>          <img src="http://www.virtual-office.com.my/images/icon-fax.png"> +6221 5890 8221<br>          <img src="http://www.virtual-office.com.my/images/icon-email.png"> cs           @ jakartavirtualoffice.com</p>
      </div>
