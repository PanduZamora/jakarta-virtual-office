...
<div id="showcase_clip"> 
  <div id="showcase"> 
    <h1>Credit Card Payment<br>
	Status: <strong>Unsuccessful</strong></h1>
    <div class="col1">
        
      <div class="rndbox3"> 
        <p>Credit card charged: FAILED</p>
        <div><br>
        </div>
        <div>INSTRUCTION TO CUSTOMER SERVICE</div>
        <div><br>
        </div>
        <div>Tell customer:</div>
        <div>I'm sorry. It seems like your bank has declined this transaction and we are unable to charge your card.</div>
        <div><br>
        </div>
        <div>Politely ask: Would you like me to try to charge another credit card.</div>
        <div>IF YES : May i have your other credit card details: Name on card, card number, expiry, cvv code, bank that issue the card</div>
        <div><br>
        </div>
        <div>IF NO: Sir or Maa'm, you can also pay by cheque, bank-in or use internet banking to transfer the fund to us.&nbsp;</div>
        <div><br>
        </div>
        <div>ASK: Would you like me to email you our bank account details?</div>
        <div>If yes, proceed to email immediately</div>
        <div><br>
        </div>
        <div>Our Maybank accounts details</div>
        <div><br>
        </div>
        <div>
          <table width="95%" border="0" cellspacing="0">
            <tbody>
              <tr>
                ...
                <td width="60%">5147 2110 2200</td>
              </tr>
              <tr>
                <td>Account Name</td>
                <td>Flexi e-Solutions Sdn Bhd</td>
              </tr>
              <tr>
                <td>Swift No</td>
