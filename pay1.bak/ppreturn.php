...
<div id="showcase_clip"> 
  <div id="showcase"> 
    <h2>Paypal Payment - Completed</h2>
    <div class="col1">
        
      <div class="rndbox3"> 
        <p>Thank you for your payment.</p>
        <p> Please feel free to contact us at our Customer Service department 
          at our <a href="http://helpdesk.flexihostings.net">helpdesk</a> if you 
          require any assistance oe question.</p>
        </div>
    </div>
