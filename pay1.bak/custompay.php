...

{
			...
			$raw_total = number_format((float)$raw_total, 2, '.', '');
				...
				//set hash
				//test
				//$hashraw = "fxe12345FXE".$ref_id."https://voffice.com.my/return.htmlhttps://voffice.com.my/gateway-callback.php".$raw_total.$curencytype.$vip."780";
	//live
				$hashraw = "qlf3FEtnFXE".$ref_id."https://voffice.com.my/return.htmlhttps://voffice.com.my/gateway-callback.php".$raw_total.$curencytype.$vip."780";
		...
		if ($_POST["payment"] == "CreditCard/OnlineBanking")

		{
			$subject_in = "voffice.com.my MPay Ref : ". $ref_id;
				$subject=$subject_in;
				$mainbody=$msg_in;
				include('../sendit.php');
				if($mail->Send()) {
				...
				$client_msg_in = "Hello ".$firstname." Below are details for your payment\r\n<br>";
		...
		?>
			...
			<input type="hidden" name="PymtMethod" value="ANY" size="135">
			<input type="hidden" name="ServiceID" value="FXE" size="135">
			<input type="hidden" name="PaymentID" value="<?=$ref_id?>" size="135">
			<input type="hidden" name="OrderNumber" value="<?=$ref_id?>" size="135">
			<input type="hidden" name="PaymentDesc" value="<?=$payfor?>" size="135">
			<input type="hidden" name="MerchantName" value="Voffice" size="135">
			<input type="hidden" name="MerchantReturnURL" value="https://voffice.com.my/return.html" size="135">
			<input type="hidden" name="MerchantCallBackURL" value="https://voffice.com.my/gateway-callback.php" size="135">
			<input type="hidden" name="Amount" value="<?=$raw_total?>" size="135">
...
<div id="showcase_clip"> 
  ...
  <div id="showcase"> 
    ...
    <div class="col1"> 
      ...
      <form name="billpay" method="post" action="custompayv2.php"  onSubmit="return validateform()">
                  ...
                  <?php
...

								{
								   ...
								   echo "<option value=\"NA\">Please select your Currrency</option>
										...
										<option value=\"CNY\">China Yuan (Ren Min Bi)</option>";
                ...
                <td> 
                  ...
                  <?php
...

								{
                              		...
                              		echo "<input class=\"form_txt\" size=\"30\" name=\"payamount\" onkeypress=\"return isNumberKey(event)\" >";
          ...
          <table width="98%" border="0">
            ...
            <tr> 
              ...
              <td width="60%"><select name="payment" id="payment" class="form_txt" onChange="showhidecc(this.value, 'showpaytype');">
                  ...
                  <option value="CreditCard/OnlineBanking">Credit Card / Online Banking</option>
...
<table border="0" width="98%" class="noborder">
            ...
            <tbody>
              ...
              <tr> 
				...
				<input name="gopay" id="gopay" type="image" value=" " class="proceed" src="../images/proceed.png"/>  
    ...
    <div class="col2"> 
	  ...
	  <div class="divider"> 
        ...
        <p> <img src="https://voffice.com.my/images/icon-phone.png"> 
          +6221 29222999<br>
          <img src="https://voffice.com.my/images/icon-fax.png"> 
		  +6221 29222990<br>
          <img src="https://voffice.com.my/images/icon-email.png"> cs 
          @ voffice.com.my</p>
