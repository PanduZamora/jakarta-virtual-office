...
define( 'EWAY_DEFAULT_CUSTOMER_ID', '14440882' );
...
class EwayPayment {
    ...
    var $myCustomerIPAddress;

    var $myCustomerBillingCountry;
    ...
    function setCustomerIPAddress( $customerIPAddress ) {

        $this->myCustomerIPAddress = $customerIPAddress;

    }

    function setCustomerBillingCountry( $customerBillingCountry ) {

        $this->myCustomerBillingCountry = $customerBillingCountry;
    ...
    function doPayment() {
        ...
        $xmlRequest = "<ewaygateway>".
				...
				"<ewayCustomerIPAddress>".htmlentities( $this->myCustomerIPAddress )."</ewayCustomerIPAddress>".
                "<ewayCustomerBillingCountry>".htmlentities( $this->myCustomerBillingCountry )."</ewayCustomerBillingCountry>".
