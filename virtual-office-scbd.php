...
<head>
  <meta charset="utf-8">
  <title>Miliki Kantor di Kawasan Bisnis Paling Strategis & Bergengsi di SCBD Jakarta</title>
...
<body class="location-detail">
        ...
        <div class="col-md-5">
          <div class="desc">
            <h1 class="title em">
              ...
              <span class="em-purple">SCBD</span>
            </h1>
            ...
            <p>
              Miliki Kantor di Kawasan Bisnis Paling Strategis & Bergengsi di SCBD Jakarta
              Virtual Office <strong>vOffice</strong>
            </p>
            <div class="icon-list">
              <p>✅ Berada di Kawasan Pusat Bisnis</p>
              <p>✅ Lokasi Strategis & Akses Mudah</p>
              <p>✅ Harga Terjangkau</p>
              <p>✅ Alamat Domisili Bisnis</p>
              <p>✅ Dedicated Phone Number</p>
              <p>✅ Mail Handling & Layanan Penjawab Telepon</p>
              <p>✅ Meeting Room</p>
            </div>
            <div class="grid-button">
              ...
              <!-- <a href="treasury-tower.php" class="btn btn-filled mt-5" target="_blank">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-12 d-flex-center">
          <div class="col-sm-4">
            <img src="images/building-image/treasury-tower.jpg" class="border-radius-5">
          </div>
          <div class="col-sm-8">
            ...
            <p class="p mb0"><b class="color-darkgrey">Floor</b> : 6</p>
            <p class="p mb0"><b class="color-darkgrey">District</b> : SCBD - Senopati</p>
            <p class="p">
            ...
            <a href="treasury-tower.php" class="btn btn-filled">
              Info Selengkapnya <i class="fa fa-arrow-right" aria-hidden="true"></i>
            </a>
            <a href="https://goo.gl/maps/dhJC7PBDDvkYwiUU6" target="_blank" class="btn btn-filled">
              Lihat Lokasi <i class="fa fa-location-arrow" aria-hidden="true"></i>
            </a>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-12 d-flex-center">
          <div class="col-sm-4">
            <img src="images/building-image/office8.jpg" class="border-radius-5">
          </div>
          <div class="col-sm-8">
            <div class="hr mb20-lg mb10-xs"></div>
            ...
            <p class="p">
              <b class="color-darkgrey">Building Information</b>
              : 57 storeys building, 279.5 meter-tall, separate elevator for high and low zone,
              ATM, Restaurant, Minimarket, 26 lifts, dedicated service lift, executive lift,
              third-tallest building in Jakarta, one of three commercial office towers in District 8,
              prayer room, executive restroom, 24/7 security
            </p>
            <a href="office8.php" class="btn btn-filled">
              Info Selengkapnya <i class="fa fa-arrow-right" aria-hidden="true"></i>
            </a>
            <a href="https://goo.gl/maps/PiTGaTiDFcRnWyqQ7" target="_blank" class="btn btn-filled">
              Lihat Lokasi <i class="fa fa-location-arrow" aria-hidden="true"></i>
            </a>
          </div>
        </div>
  ...
  <section class="service-section p_relative sec-pad centred" id="section3" style="background-image: url('img/new/bg-jakarta.jpg'); background-position: fixed;">
  ...
  <section class="service-section p_relative sec-pad centred" id="section4" style="background-image: url('img/new/bg-jakarta.jpg'); background-position: fixed;">
    <div class="auto-container">
      ...
      <div class="row mt-5">
        ...
        <div class="col-md-6">
          <div class="videoscbd">
            <video controls class="mt-5" id="scbd" poster="assets/img/why-voffice/thumb.png">
              <source src="assets/img/why-voffice/vid.mp4" type="video/mp4">
              <source src="assets/img/why-voffice/vid.ogg" type="video/ogg">
