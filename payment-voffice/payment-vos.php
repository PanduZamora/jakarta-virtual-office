...
\Midtrans\Config::$serverKey = 'SB-Mid-server-NOkpdfPRE7E4XbPVc387LcAV';
...
<head>
    ...
    <script id="client-key" type="text/javascript"
            src="https://app.sandbox.midtrans.com/snap/snap.js"
            data-client-key="SB-Mid-client-Aurqtkz0yKL6OY3w"></script>
      ...
      <div class="modal-content">
        ...
        <div class="row summary">
            <div class="col-sm-12">
                ...
                <small class="text-right" style="display: block;">*harga sudah termasuk PPN (Pajak Pertambahan Nilai) 10%</small>
                <small class="text-right" style="display: block;">**pembayaran ini sudah termasuk WHT (Withholding Tax / Pajak yang dipungut oleh pihak ketiga termasuk Pph 4 ayat 2)</small>
                <small class="text-right" style="display: block;">***vOffice dan Klien sepakat untuk tunduk pada kewajiban perpajakan yang berlaku di Indonesia</small>
            </div>
        </div>
