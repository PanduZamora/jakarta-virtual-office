...
<head>
    ...
    <title>Pendirian CV Murah di Jakarta + Virtual Office - vOffice</title>

    <meta name="description" content="Pendirian CV Murah di Jakarta ✔️ Akta Pendirian & SK Kemenkumham ✔️ NPWP & SKT ✔️ NIB & Sertifikat ✔️ Virtual Office ✔️ Dedicated Phone Number" />
    ...
    <div class="main-container">
            ...
            <ul class="slides">
                <li class="image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="img/bg-plan-private-office.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row text-left">
                            <div class="col-md-12 pt-xs-32 mt-5">
                                <h2 class="bold mb0"> Jasa Pendirian CV + Virtual Office <br>
                                </h2>
        ...
        <section id="selengkapnya">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img src="img/business_partner.jpg" alt="" class="img-fluid img-pt-lite">
                    </div>
                    <div class="col-md-6">
