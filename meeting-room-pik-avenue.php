...
<head>
    <meta charset="utf-8">
    <title>Ruang Rapat, Meeting Room PIK Avenue, Jakarta Utara, vOffice</title>

    <meta name="description" content="Sewa Ruang Rapat, Ruang Meeting, Meeting Room di Jakarta Utara PIK Avenue, vOffice Indonesia, Jakarta Virtual Office, Jakarta Serviced
Office, Indonesia Office - Instant Office di Jakarta, Indonesia -
Shared Office and Virtual Office Service in Jakarta Indonesia" />

    <meta name="keywords" content="meeting room, ruang rapat, ruang meeting, virtual office, PIK, Jakarta Utara, indonesia,
            ...
            <ul class="slides">
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/lokasi-gedung-voffice/pik/pik-1.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="mb40 mb-xs-16 large mt64 mt-xs-0">vOffice Gold Coast PIK</h1>
                                <h6 class="uppercase mb0">Gold Coast Office Eiffel Tower Lt 12 Jl Pantai Indah Kapuk,</h6>
                                <h6 class="uppercase mb40">Penjaringan Jakarta Utara</h6>
                ...
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="virtual office kencana tower" class="background-image" src="images/lokasi-gedung-voffice/pik/pik-5.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                ...
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="virtual office kencana tower" class="background-image" src="img/locations/pik-avenue/pik-view4.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h6 class="uppercase mb0">
                                    GOLD COAST OFFICE EIFFEL TOWER LT 12 JL PANTAI INDAH KAPUK,
                                    PENJARINGAN JAKARTA UTARA
                                </h6>
                                <h6 class="uppercase mb40">Jakarta Utara 14460</h6>
                                <a class="btn btn-lg mb-xs-32" href="#centerdetails">Start Exploring</a>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="bold title">vOffice Gold Coast PIK</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <img class="mt80 mt-xs-0 mb24" alt="Pic" src="images/lokasi-gedung-voffice/pik/pik-5.jpg">
                                        <img class="col-md-pull-4 relative mb24" alt="Pic" src="images/lokasi-gedung-voffice/pik/pik-4.jpg">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="iframe-container mb24">
                                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3967.213979045306!2d106.73625031476855!3d-6.101860195581611!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6a1d19854516e9%3A0x8a7b918c1b1a6317!2sGold%20Coast%20Apartment%20PIK!5e0!3m2!1sen!2sid!4v1685327819999!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                    </div>

                                </div>
                                <div class="col-md-6">
                                    <h4 class="bold">Contact Us</h4>
                                    <h3 class="mb40 mb-xs-16 large mt-xs-0">vOffice Gold Coast PIK</h3>
                                    <h6 class="uppercase mb0">Gold Coast Office Eiffel Tower Lt 12 Jl Pantai Indah Kapuk,</h6>
                                    <h6 class="uppercase mb40">Penjaringan Jakarta Utara</h6>
