        ...
        <ul class="slides">
            <li class="image-bg pt-xs-120">
                <div class="background-image-holder">
                    <img alt="image" class="background-image" src="img/headernew-35.jpg">
                </div>
                <div class="container v-align-transform">
                    <div class="row text-left">
                        <div class="col-md-10 mt88 mt-xs-36">
                            <h4 class="mb8 number bold uppercase">Get Cash Back Up To</h4>
                            <h1 class="mb0 bold number pt-xs-36">2.000.000 + Free Meeting Room </h1>
                            <h4 class="mb8 number bold">For Our Virtual Office Plan</h4>
                            <a class="btn btn-lg btn-filled" href="#seemore">Lihat Selengkapnya!</a>
                            <p class="small pb-xs-16 mb0">(Promo Valid until 30 April 2019)</p>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="col-sm-6 mb20">
                        <img src="images/promo-april.jpg">
                    </div>
                    <div class="col-sm-6">
                        <div class="feature boxed3">
                            <h4 class="mb8 bold text-center color-black">Daftar Sekarang</h5>
                                ...
                                <form class="form-email"
                                    ...
                                    <input type="text" name="promo-maret" hidden="hidden"
                                           value="promo-cny"
                                           id="promo-cny">
