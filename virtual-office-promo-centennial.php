        ...
        <ul class="slides">
            <li class="image-bg pt-xs-120">
                <div class="background-image-holder">
                    <img alt="image" class="background-image" src="img/new/call-answering.jpg">
                </div>
                <div class="container v-align-transform">
                    <div class="row text-left">
                        <div class="col-md-10 mt88 mt-xs-36">
                            <h1 class="mb0 bold number pt-xs-36">Free 3 Month Call Answering</h1>
                            <h4 class="mb8 number bold">For any virtual office plan</h4>
                            <a class="btn btn-lg btn-filled" href="#seemore">Lihat Selengkapnya!</a>
                            <p class="small pb-xs-16 mb0">*Terms & Conditions apply</p>
                            <p class="small pb-xs-16 mb0">*Valid until 31 March 2019</p>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="col-sm-6 mb20">
                        <img src="images/promo-voffice-helloka.jpg">
                    </div>
                    <div class="col-sm-6">
                        <div class="feature boxed3">
                            <h4 class="mb8 bold text-center color-black">Daftar Sekarang</h5>
                                ...
                                <form class="form-email"
                                    ...
                                    <input type="text" name="vo_ct" hidden="hidden"
                                           value="vo_ct"
                                           id="vo_ct">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <h2 class="inline-block bold number p32 p0-xs">See Our Virtual Office Plan</h2><br>
                    <a class="btn-lg btn btn-whiteblack"
                       href="virtual-office-di-jakarta.php">
                        Click Here</a>
                </div>
            </div>
        </div>
