...
<head>
    <meta charset="utf-8">
    <title>Sewa Ruang Rapat, Meeting Room Intiland Tower, Panglima Sudirman, Surabaya, vOffice</title>

    <meta name="description" content="Sewa Ruang Rapat, Ruang Meeting, Meeting ROom di Intiland Tower, Panglima Sudirman, Surabaya, vOffice Indonesia, Surabaya Virtual Office, Surabaya Serviced
Office, Indonesia Office - Instant Office di Surabaya, Indonesia -
Shared Office and Virtual Office Service in Surabaya Indonesia" />

    <meta name="keywords" content="Intiland Tower, virtual Office, surabaya, panglima Sudirman, virtual office surabaya, indonesia,
serviced office, temporary office, shared office, office virtual,
indonesia virtual office, start business, cheap office, short term office, kantor virtual surabaya, sewa kantor, ruang
kantor, surabaya, indonesia, kantor murah, virtual office, virtual
address surabaya, address, business office, receptionist, courier,
personal assistant" />
            ...
            <ul class="slides">
                <li class="overlay image-bg pt-xs-120">
                    ...
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="mb40 mb-xs-16 large mt64 mt-xs-0">Intiland Tower</h1>
                ...
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="img/locations/intiland-tower/int-tower3.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                ...
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="img/locations/intiland-tower/int-tower1.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <h1 class="mb40 mb-xs-16 large mt64 mt-xs-0">Intiland Tower</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="bold title">Intiland Tower</h4>
                            <hr class="title-breaker left">
                            <div class="row">
                                <div class="col-sm-6 col-sm-offset-1">
                                    <div class="feature bordered">
                                        <h1 class="large uppercase mb64 mb-xs-24">Meeting Room</h1>
                                        <p class="mb80 mb-xs-24">
                                            Our selection of comfortable meeting rooms come in all sizes, You would not only get a strategic location as your meeting venue, you would not only get the affordable price, but you would also get the ambiance and vibes you couldn’t find anywhere else when you have a meeting. Other than that, there are several meeting room facilities at your disposal
                                        </p>
                                ...
                                <div class="col-sm-5">
                                    <img class="mt80 mt-xs-0 mb24" alt="Pic" src="img/locations/intiland-tower/int-tower2.jpg">
                                    <img class="col-md-pull-4 relative mb24" alt="Pic" src="img/locations/intiland-tower/int-tower3.jpg">
                                </div>
                            </div>


                            <hr class="fade-3-4 mb24">
                            <?php include('plan-meeting-room.php'); ?>

                            <hr class="fade-3-4 mb24">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4 class="bold title">Our Facilities </h4>
                                    <hr class="title-breaker left">

                                    <div class="row text-center">
                                        <div class="col-sm-offset-1 col-sm-5 col-xs-6">
                                            <img src="img/eventspace/cre8-eventspace-1.png" class="mb16" width="80px">
                                            <h5 class="uppercase">50 MBPS WIRELESS CONNECTION</h5>
                                        </div>
                                        <div class="col-sm-5 col-xs-6">
                                            <img src="img/eventspace/cre8-eventspace-2.png" class="mb16" width="80px">
                                    ...
                                    <div class="row text-center">
                                        <div class="col-sm-offset-1 col-sm-5 col-xs-6">
                                            <img src="img/eventspace/cre8-eventspace-3.png" class="mb16" width="80px">
                                            <h5 class="uppercase">PROJECTOR & SCREEN</h5>
                                        </div>
                                        <div class="col-sm-5 col-xs-6">
                                            <img src="img/eventspace/cre8-eventspace-4.png" class="mb16" width="80px">
                                    ...
                                    <div class="row text-center">
                                        <div class="col-sm-offset-1 col-sm-5 col-xs-6">
                                            <img src="img/eventspace/cre8-eventspace-5.png" class="mb16" width="80px">
                                            <h5 class="uppercase">BACKDROP RIDGING</h5>
                                        </div>
                                        <div class="col-sm-5 col-xs-6">
                                            <img src="img/eventspace/cre8-eventspace-6.png" class="mb16" width="80px">
                                    ...
                                    <div class="row text-center">
                                        <div class="col-sm-offset-1 col-sm-5 col-xs-6">
                                            <img src="img/eventspace/cre8-eventspace-7.png" class="mb16" width="80px">
                                            <h5 class="uppercase">FRESH PAPERS & PENS</h5>
                                        </div>
                                        <div class="col-sm-5 col-xs-6">
                                            <img src="img/eventspace/cre8-eventspace-8.png" class="mb16" width="80px">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="iframe-container mb24">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3957.7167072221087!2d112.7406414143202!3d-7.273042394750331!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7f960c2263c37%3A0x893da17820826fa2!2sIntiland+Tower+Surabaya!5e0!3m2!1sid!2sid!4v1503991493489" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                                </div>

                            </div>
                            <div class="col-md-6">
                                <h4 class="bold">Contact Us</h4>
                                <p class="mb0">Intiland Tower</p>
                                <p class="mb0">Level 3, Jl Panglima Sudirman No.101-103</p>
                                <p>Jawa Timur, 60271, Indonesia</p>
