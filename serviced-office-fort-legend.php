...
<head>
    <meta charset="utf-8">
    <title>Office Space in Bonifacio Philliphines, Serviced Office Fort Legend Tower</title>

    <meta name="description" content="Office Space in Bonifacio Philliphines, Private Office, Serviced Office Fort Legend Tower" />
            ...
            <ul class="slides">
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_ph/fort_legend/flt-gallery1.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-8 col-sm-8">
                                <h1 class="mb40 mb-xs-16 large mt64 mt-xs-0">Fort Legend Tower</h1>
                                <h6 class="uppercase mb0">Level 10-1, 31st Street & 3rd Avenue</h6>
                ...
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_ph/fort_legend/flt-gallery2.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-8 col-sm-8">
                ...
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_ph/fort_legend/flt-gallery3.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-8 col-sm-8">
                ...
                <li class="overlay image-bg">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="images/voffice_ph/fort_legend/flt-gallery4.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-8 col-sm-8">
                                ...
                                <div class="image-tile hover-tile text-center">
                                    ...
                                    <div class="hover-state">
                                        <a>
                                            ...
                                            <h6 class="uppercase">Fort Legend</h6>
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        ...
                        <table class="table table-blank">
                            <thead>
                                <tr>
                                    <th colspan="2">Establishments close to Fort Legend Tower</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            ...
                                            <li>Yoga Plus</li>
                                            <li>Urban Ashram Manila</li>
                                            <li>BGC Stop-over</li>
                                            <li>BGC Bus stop</li>
                                            <a href="https://goo.gl/maps/VHxNPwVhcyE2" target="_blank">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="iframe-container mb24">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m24!1m12!1m3!1d3861.791918902076!2d121.0449566640839!3d14.553888582123314!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m9!3e6!4m3!3m2!1d14.5539277!2d121.0477415!4m3!3m2!1d14.554062!2d121.04689099999999!5e0!3m2!1sid!2sid!4v1513759480331" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>

                    </div>
                    <div class="col-md-6">
                        <h4 class="bold">Contact Us</h4>
                        <p class="mb0">Fort Legend Tower</p>
                        <p class="mb0">Level 10-1, 31st Street & 3rd Avenue</p>
                        <p class="mb0">Bonifacio Global City, Taguig 1632 Philippines</p>
