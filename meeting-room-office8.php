...
<head>
    <meta charset="utf-8">
    <title>Meeting room di SCBD Sudirman Jakarta | Ruang Meeting | Ruang Rapat</title>

    <meta name="description" content="Sewa Meeting Room, Ruang Rapat, Ruang Meeting, SCBD Sudirman Jakarta"/>

    <meta name="keywords" content="meeting room, ruang rapat, ruang meeting, SCBD, Sudirman, voffice, Office 8, Jakarta Selatan, virtual office jakarta, indonesia,
        ...
        <ul class="slides">
            <li class="overlay image-bg pt-xs-120">
                ...
                <div class="container v-align-transform">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="mb40 mb-xs-16 large mt64 mt-xs-0">Office 8</h1>
            ...
            <li class="overlay image-bg pt-xs-120">
                <div class="background-image-holder">
                    <img alt="virtual office sudirman" class="background-image" src="img/locations/office8/office8-lounge2.jpg">
                </div>
                <div class="container v-align-transform">
                    <div class="row">
                        <div class="col-md-12">
            ...
            <li class="overlay image-bg pt-xs-120">
                <div class="background-image-holder">
                    <img alt="virtual office SCBD" class="background-image" src="img/locations/office8/office8-lounge3.jpg">
                </div>
                <div class="container v-align-transform">
                    <div class="row">
                        <div class="col-md-12">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="bold title">Office 8</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <img class="mt80 mt-xs-0 mb24" alt="Pic" src="img/locations/office8/office8-meet.jpg">
                                <img class="col-md-pull-4 relative mb24" alt="Pic" src="img/locations/office8/office8-lounge3.jpg">
                            </div>
                        </div>
            ...
            <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.2574015059386!2d106.80351441426883!3d-6.229757362742965!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f14535b4d743%3A0x65197cc44b2b8f00!2sOffice+8!5e0!3m2!1sid!2sid!4v1496915360467"
