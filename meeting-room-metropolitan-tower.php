...
<head>
    <meta charset="utf-8">
    <title>Sewa Ruang Meeting, Meeting Room, di Cilandak, TB Simatupang, Metropolitan Tower</title>

    <meta name="description" content="Sewa Ruang Meting, Ruang Rapat, Meeting Room di Cilandak, Virtual Office di Cilandak, TB Simatupang, Jakarta Selatan, Metropolitan Tower | vOffice Indonesia, Virtual Office Jakarta telp +6221 3049 000
    vOffice Indonesia, sewa kantor kuningan, sewa serviced office kuningan, jakarta selatan" />

    <meta name="keywords" content="meeting room, ruang meeting, ruang rapat, cilandak, tb simatupang, voffice, Jakarta Selatan, virtual office jakarta, indonesia,
            ...
            <ul class="slides">
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="img/locations/metropolitan/metro-meet2.jpg">
                    </div>

                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="mb40 mb-xs-16 large mt64 mt-xs-0">Metropolitan Tower</h1>
                ...
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="img/locations/metropolitan/metro-lounge3.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                ...
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="img/locations/metropolitan/metro-event.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="bold title">Metropolitan Tower</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <img class="mt80 mt-xs-0 mb24" alt="Pic" src="img/locations/metropolitan/metro-meet2.jpg">
                                        <img class="col-md-pull-4 relative mb24" alt="Pic" src="img/locations/metropolitan/metro-lounge3.jpg">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class=<h4 class="bold">Contact Us</h4>
