...
<head>
    <meta charset="utf-8">
    <title>Office Space Cilandak | Serviced Office The CEO Building </title>

    <meta name="description" content="Office Space di Cilandak, Private Office, Serviced Office CEO Building" />
            ...
            <ul class="slides">
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="image" class="background-image" src="img/locations/ceo/ceo-so.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="mbmin-1 mb-xs-32 large mt12 mt-xs-0">Serviced Office</h1>
                                <h1 class="mbmin-1 mb-xs-16 large mt-xs-0">The CEO Building</h1>
                                <h6 class="uppercase mb0">Level 12, Jl TB Simatupang No. 18C</h6>
                                <h6 class="uppercase mb20">Jakarta Selatan 12430</h6>
                ...
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="virtual office sudirman" class="background-image" src="img/locations/ceo/ceo-meet.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                ...
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="virtual office SCBD" class="background-image" src="img/locations/ceo/ceo-lounge.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        ...
                        <p>
                            At vOffice - The Ceo Building center, we take pride in serving our clients with outmost care and professionalism.
                        </p>
                        <hr>
                        ...
                        <table class="table table-blank">
                            <thead>
                                <tr>
                                    <th colspan="2">Establishments close to The Ceo Building</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>Mercure Jakarta Simatupang
                                            </li>
                                            <li>Swiss Bellin Hotel</li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <td>
                                    <ul>
                                        <li>Jakarta Outer Ring Road Toll</li>
                                        <li>Gold's Gym</li>
                                    </ul>
                                </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <img src="img/locations/ceo/ceo-floor.png">
                                    </td>
                    ...
                    <div class="col-sm-6 col-md-5 col-md-offset-1 mt24 mt-xs-64">
                        ...
                        <div>
                            ...
                            <div class="iframe-container mb24">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.788931076298!2d106.79522311476947!3d-6.291448495446485!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ed8b4f2780f3%3A0xcb2c946fc389fc32!2sTHE+CEO+BUILDING!5e0!3m2!1sid!2sid!4v1497499127424" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                            </div>
                        </div>

                        <div class="feature bordered">
                            <h4 class="bold">Contact Us</h4>
                            <p class="mb0">The CEO Building</p>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="row masonry masonryFlyIn mb16">
                                ...
                                <div class="image-tile hover-tile text-center">
                                    ...
                                    <div class="hover-state">
                                        <a>
                                            ...
                                            <h6 class="uppercase">The Ceo Building</h6>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4 masonry-item project" data-filter="People">
                                <div class="image-tile hover-tile text-center">
                                    <img alt="image" class="background-image" src="img/locations/ceo/ceo-meet.jpg">
                                    <div class="hover-state">
                                        <a href="meeting-room-centennial-tower.php">
                            ...
                            <div class="col-sm-4 masonry-item project" data-filter="People">
                                <div class="image-tile hover-tile text-center">
                                    <img alt="image" class="background-image" src="img/locations/ceo/ceo-lounge.jpg">
                                    <div class="hover-state">
                                        <a>
