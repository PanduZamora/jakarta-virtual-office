...
<head>
    <meta charset="utf-8">
    <title>Ruang Meeting, Meeting Room Cilandak, The CEO Building, vOffice Indonesia</title>

    <meta name="description" content="Sewa Ruang meeting, ruang rapat, meeting room di Jakarta Selatan, Cilandak, The CEO Building, vOffice Indonesia, Jakarta Virtual Office, Jakarta Serviced
Office, Indonesia Office - Instant Office di Jakarta, Indonesia -
Shared Office and Virtual Office Service in Jakarta Indonesia" />

    <meta name="keywords" content="Cilandak, Jakarta Selatan, meeting room, ruang rapat, ruang meeting, virtual office jakarta, indonesia,
            ...
            <ul class="slides">
                <li class="overlay image-bg pt-xs-120">
                    ...
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="mb40 mb-xs-16 large mt64 mt-xs-0">The CEO Building</h1>
                                <h6 class="uppercase mb0">Level 12, Jl TB Simatupang No. 18C</h6>
                                <h6 class="uppercase mb40">Jakarta Selatan 12430</h6>
                ...
                <li class="overlay image-bg pt-xs-120">
                    <div class="background-image-holder">
                        <img alt="virtual office sudirman" class="background-image" src="img/locations/ceo/ceo-so.jpg">
                    </div>
                    <div class="container v-align-transform">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="bold title">The Ceo Building</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <img class="mt80 mt-xs-0 mb24" alt="Pic" src="img/locations/ceo/ceo-meet.jpg">
                                        <img class="col-md-pull-4 relative mb24" alt="Pic" src="img/locations/ceo/ceo-lounge.jpg">
                                    </div>
                                </div>
