...
<head>
    <meta charset="utf-8">
    <title>Office Space Mega Kuningan, Serviced Office Menara Rajawali</title>

    <meta name="description" content="Office Space Mega Kuningan, Private Office, Serviced Office Menara Rajawali"/>
        ...
        <ul class="slides">
            <li class="overlay image-bg pt-xs-120">
                <div class="background-image-holder">
                    <img alt="image" class="background-image" src="img/locations/menara-rajawali/mr-so.jpg">
                </div>
                <div class="container v-align-transform">
                    <div class="row">
                        <div class="col-md-12">
                              <h1 class="mbmin-1 mb-xs-32 mt12 large mt-xs-0">Serviced Office</h1>
                            <h1 class="mbmin-1 mb-xs-16 large mt-xs-0">Menara Rajawali</h1>
                            <h6 class="uppercase mb20">Level 7-1, Jl. DR Ide Anak Agung Gde Agung, Kawasan Mega Kuningan, Jakarta Selatan 12950</h6>
            ...
            <li class="overlay image-bg pt-xs-120">
                <div class="background-image-holder">
                    <img alt="image" class="background-image" src="img/locations/menara-rajawali/mr-meet.jpg">
                </div>
                <div class="container v-align-transform">
                    <div class="row">
                        <div class="col-md-12">
            ...
            <li class="overlay image-bg pt-xs-120">
                <div class="background-image-holder">
                    <img alt="image" class="background-image" src="img/locations/menara-rajawali/mr-lounge.jpg">
                </div>
                <div class="container v-align-transform">
                    <div class="row">
                        <div class="col-md-12">
        ...
        <div class="container">
            <div class="row">
                        <div class="col-md-6 col-sm-6">
                            ...
                            <p>
                                At vOffice - Menara Rajawali center, we take pride in serving our clients with outmost care and professionalism.
                            </p>
                            <hr>
                            ...
                            <tr>
                                ...
                                <td>
                                <ul>
                                <li>Bellagio Residence
                                </li>
                                <li>Oakwood Premiere Cozmo</li>
                                <li>Sommerset</li>
                                <li>Ascott Kuningan Jakarta</li>
                                </ul>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                <ul>
                                <li>Royal Danish Embassy</li>
                                <li>Royal Norwegian Embassy                </li>
                                <li>Embassy of Sweden</li>
                                <li>Embassy of China           </li>
                                </ul>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                <img src="img/locations/menara-rajawali/mr-floor.png">
                            </td>
                        ...
                        <div class="feature bordered">
                            ...
                            <p class="mb0">Menara Rajawali</p>
                            <p class="mb0">Level 7-1, Jl. DR Ide Anak Agung Gde Agung, Kawasan Mega Kuningan</p>
                    ...
                    <div class="row masonry masonryFlyIn mb16">
                        <div class="col-sm-4 masonry-item project" data-filter="People">
                            <div class="image-tile hover-tile text-center">
                                <img alt="image" class="background-image" src="img/locations/menara-rajawali/mr-so-overlay.jpg">
                                <div class="hover-state">
                                    <a>
                                        <h3 class="uppercase mb8">Private Office</h3>
                                        <h6 class="uppercase">Menara Rajawali</h6>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4 masonry-item project" data-filter="People">
                            <div class="image-tile hover-tile text-center">
                               <img alt="image" class="background-image" src="img/locations/menara-rajawali/mr-meet-overlay.jpg">
                                <div class="hover-state">
                                    <a href="meeting-room-menara-rajawali.php">
