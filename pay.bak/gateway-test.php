...
die();
	...
	$ref = "VOMYNO"."-".time();
	//test
	$hashraw = "fxe12345FXE".$ref."https://voffice.com.my/pay/return.phphttps://voffice.com.my/gateway-callback.php100.14MYR192.168.2.35780";
	//live
	//$hashraw = "qlf3FEtnFXE".$ref."https://voffice.com.my/gateway-test.phphttps://voffice.com.my/gateway-callback.php100.14MYR192.168.2.35780";
...
<input  name="MerchantReturnURL" value="https://voffice.com.my/pay/return.php" size="135">
<br><br>MerchantCallBackURL<br>
<input  name="MerchantCallBackURL" value="https://voffice.com.my/gateway-callback.php" size="135">
<br><br>Amount<br>
<input  name="Amount" value="100.14" size="135">
