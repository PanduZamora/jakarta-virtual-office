...
echo "<script src=\"validateformcc.js\"></script>";
...
if ($_POST["go_pay"])
{
				...
				$cc_email = "albert.g@flexiesolutions.com, sean@flexiesolutions.com, linda@flexiesolutions.com";
			...
			$raw_total = str_replace(',', '', $_POST["payamount"]);
...
<div id="showcase_clip"> 
  ...
  <div id="showcase"> 
    ...
    <div class="col1"> 
      ...
      <form name="billpay" method="post" action="chargecc.php" onsubmit="return validateform();">
        <div class="rndbox3"> 
          ...
          <table border="0" width="100%">
            ...
            <tbody>
              ...
              <tr> 
                ...
                <td valign="top">Payment Amount :<font color="#FF0000">*</font>
              ...
              <tr> 
                ...
                <td valign="top">Additional Comments: <font color="#FF0000">*</font></td>
          ...
          <p><img src="images/t03.gif" width="190" height="30"></p>
            ...
            <table width="98%" border="0" cellpadding="0"  class="innertd">
              ...
              <tr> 
                ...
                <td > <input class="form_txt" id="cc_name" size="30" name="cc_name"> 
