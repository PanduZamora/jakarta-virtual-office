...
if ($_POST["gopay_x"])
{
		...
		//{
...

			{
            	  ...
            	  $result = mysql_query($exratesnow, $dbmrates) or die( mysql_error());
			...
			$link = EWAYOK;
			  ...
			  $eway->setTransactionData("CustomerInvoiceDescription", "VOPay");

			  $eway->setTransactionData("CustomerInvoiceRef", $ref_id);
...
<table border="0" width="98%" class="noborder">
    ...
    <div class="col2"> 
      ...
      <p><strong>We know different companies have different needs.</strong> So 
        ...
        when we designed Virtual-Office.com.my, we made it versatile enough to 
	  ...
	  <div class="divider"> 
        <p><strong>KUALA LUMPUR, MALAYSIA</strong><br>
          B-5-8 Plaza Mont Kiara, Mont Kiara<br>50480, Kuala Lumpur, Malaysia</p>

        <p> <img src="http://www.virtual-office.com.my/images/icon-phone.png"> 
          +603 6207 1500<br>
          <img src="http://www.virtual-office.com.my/images/icon-fax.png"> +603 
          6207 5400<br>
